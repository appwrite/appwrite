...
$movies = [
    ...
    [
     ...
     [
        ...
        'releaseYear' => 2016,
        'director' => 'jon Favreau',
        'generes' => ['Adventure, Musical, Live-Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'releaseYear' => 2016,
        'director' => 'James Bobin',
        'generes' => ['Adventure, Live- Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Finding Dory',
    ...
    [
        ...
        'generes' => ['Adventure, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Moana',
    ...
    [
        ...
        'generes' => ['Adventure, Musical, Romantic, Live-Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'generes' => ['Adventure, Romantic, Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Cars 3',
        'releaseYear' => 2017,
        'director' => 'Brian Fee',
        'generes' => ['Adventure, Musical, Animation, Comedy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Coco',
        'releaseYear' => 2017,
        'director' => 'Lee Unkrich',
        'generes' => ['Adventure, Musical, Animation, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Incredibles 2',
        'releaseYear' => 2018,
        'director' => 'Brad Bird',
        'generes' => ['Adventure, Animation, Action, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'generes' => ['Comedy, Drama, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'generes' => ['Mystery, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'generes' => ['Comedy, Musical, Animation, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'releaseYear' => 2018,
        'director' => 'Rob Marshall',
        'generes' => ['Comedy, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Dumbo',
        'releaseYear' => 2019,
        'director' => 'Tim Burton',
        'generes' => ['Drama, Musical, Animation, Live-Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Aladdin',
        ...
        'generes' => ['Comedy, Romantic, Live-Action, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Toy Story 4',
        ...
        'generes' => ['Comedy, Animation, Adventure, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'The Lion King',
        'releaseYear' => 2019,
        'director' => 'Jon Favreau',
        'generes' => ['Comedy, Drama, Romantic, Live-Action, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        ...
        'generes' => ['Drama, Musical, Romantic, Live-Action, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Lady and the Tramp',
        ...
        'generes' => ['Comedy, Romantic, Animation, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Noelle',
    ...
    [
        ...
        'releaseYear' => 2019,
        'director' => 'Chris Buck, Jennifer Lee',
        'generes' => ['Comedy, Drama, Adventure, Romantic, Animation, Musical, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Onward',
        'releaseYear' => 2020,
        'director' => 'Dan Scanlon',
        'generes' => ['Comedy, Drama, Musical, Animation, Adventure, Fantasy, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Mulan',
        'releaseYear' => 2020,
        'director' => 'Niki Caro',
        'generes' => ['Drama,Action, Adventure, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Cruella',
        ...
        'generes' => ['Crime, Action, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Raya and the Last Dragon',
        'releaseYear' => 2021,
        'director' => 'Don Hall, Carlos López Estrada, Dean Wellins',
        'generes' => ['Animation, Adventure, Family'],
        'langauges' => ['English'],
    ],
    [
        'name' => 'Soul',
     ...
     [
        ...
        'generes' => ['Comedy, Adventure, Family'],
        'langauges' => ['English'],
    ],
