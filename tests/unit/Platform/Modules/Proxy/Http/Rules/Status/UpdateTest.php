...
final class UpdateTest extends TestCase
{
    ...
    private function runAction(?\Closure $verify = null, int $project = 7): void
    {
        ...
        $action->action('rule', $this->createStub(Response::class), new Certificate($this->publisher, new Queue('certificates')), new Event($this->publisher), new Document(['$id' => 'project', '$sequence' => $project]), $this->database, new Log(), new Authorization(), (new Bus())->setResolver(static fn () => null));
    }
}
