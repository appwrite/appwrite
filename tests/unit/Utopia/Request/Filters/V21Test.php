...
final class V21Test extends TestCase
{
    ...
    public static function functionsCreateTemplateDeploymentProvider(): \Iterator
    {
        yield 'convert version to type and reference' => [
            [
        ...
        yield 'handle version with semver string' => [
            [
                'version' => 'v2.3.1',
        ...
        yield 'skip conversion when version is empty string' => [
            [
                'templateId' => 'template123',
                'version' => '',
            ],
        ...
        yield 'skip conversion when version is missing' => [
            [
                'templateId' => 'template123',
            ],
            [
        ...
        yield 'preserve other fields when converting version' => [
            [
                'templateId' => 'template123',
                'version' => '3.0.0',
                'activate' => true,
    ...
    public static function sitesCreateTemplateDeploymentProvider(): \Iterator
    {
        yield 'convert version to type and reference' => [
            [
        ...
        yield 'skip conversion when version is empty' => [
            [
                'templateId' => 'site-template123',
                'version' => '',
            ],
    ...
    {
        yield 'convert specification to buildSpecification and runtimeSpecification' => [
            [
                'name' => 'test-function',
                'runtime' => 'node-18.0',
        ...
        yield 'skip conversion when specification is empty' => [
            [
                'name' => 'test-function',
                'runtime' => 'node-18.0',
                'specification' => '',
        ...
        yield 'skip conversion when specification is missing' => [
            [
                'name' => 'test-function',
                'runtime' => 'node-18.0',
            ],
        ...
        yield 'preserve other fields when converting specification' => [
            [
                'name' => 'test-function',
    ...
    public static function sitesCreateProvider(): \Iterator
    {
        yield 'convert specification to buildSpecification and runtimeSpecification' => [
            [
                'name' => 'test-site',
    ...
    public static function functionsUpdateProvider(): \Iterator
    {
        yield 'convert specification to buildSpecification and runtimeSpecification' => [
            [
    ...
    public static function sitesUpdateProvider(): \Iterator
    {
        yield 'convert specification to buildSpecification and runtimeSpecification' => [
            [
                'name' => 'updated-site',
    ...
    public static function unmatchedModelProvider(): \Iterator
    {
        ...
        yield 'empty content for unmatched model' => [
            'users.list',
            [],
            []
        ];
        yield 'content with specification for unmatched model is not converted' => [
            'deployments.create',
            [
                'specification' => 's-1vcpu-512mb',
                'name' => 'test',
        ...
        yield 'content with version for unmatched model is not converted' => [
