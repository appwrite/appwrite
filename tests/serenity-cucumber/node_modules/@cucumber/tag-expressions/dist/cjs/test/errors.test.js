...
var tests = js_yaml_1.default.load(fs_1.default.readFileSync("".concat(testDataDir_js_1.testDataDir, "/errors.yml"), 'utf-8'));
describe('Errors', function () {
    var e_1, _a;
    var _loop_1 = function (test_1) {
        it("fails to parse \"".concat(test_1.expression, "\" with \"").concat(test_1.error, "\""), function () {
            assert_1.default.throws(function () { return (0, index_js_1.default)(test_1.expression); }, { message: test_1.error });
        });
    };
    try {
