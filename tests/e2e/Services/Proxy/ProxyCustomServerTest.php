...
class ProxyCustomServerTest extends Scope
{
    ...
    public function testCreateRuleApex(): void
    {
        ...
        $rule = $this->createAPIRule($domain);
        $this->assertEquals(201, $rule['headers']['status-code']);
        $this->assertEquals(RULE_STATUS_CREATED, $rule['body']['status']);
    }
    ...
    public function testUpdateRule(): void
    {
        ...
        $rule = $this->createAPIRule($domain);
        $this->assertEquals(201, $rule['headers']['status-code']);
        $this->assertEquals(RULE_STATUS_VERIFIED, $rule['body']['status']);
    ...
    public function testRuleVerification(): void
    {
        ...
        $this->assertEquals(201, $rule['headers']['status-code']);
        $this->assertEquals(RULE_STATUS_CERTIFICATE_GENERATING, $rule['body']['status']);
    ...
    public function testUpdateRuleVerificationWithSameDataUpdatesTimestamp(): void
    {
        ...
        $this->assertEquals(RULE_STATUS_CREATED, $ruleAfterUpdate['body']['status']);
