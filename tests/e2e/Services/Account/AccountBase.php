...
trait AccountBase
{
    ...
    public function testGetAccountLogs($data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($response['body']['logs'][1]['time']));
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($response['body']['logs'][2]['time']));
