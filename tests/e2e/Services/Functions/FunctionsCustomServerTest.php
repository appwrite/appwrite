...
class FunctionsCustomServerTest extends Scope
{
    ...
    public function testCreateCustomDenoExecution()
    {
        // Deno does not have support for ARM, so tests would be failing on most of the dev team
        // For this reason, we decided to not implement Deno tests for now
