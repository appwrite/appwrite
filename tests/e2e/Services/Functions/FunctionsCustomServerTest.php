...
class FunctionsCustomServerTest extends Scope
{
    ...
    public function testVariables(): void
    {
        ...
        $this->assertEquals('functionKey1', $variable['body']['key']);
        $this->assertEquals('functionValue1', $variable['body']['value']);
        ...
        // get secret variable
        $secretVariable = $this->getVariable($functionId, $secretVariable['body']['$id']);
        ...
        // update variable
        $variable = $this->updateVariable($functionId, $variable['body']['$id'], [
            'key' => 'functionKey1Updated',
            'value' => 'functionValue1Updated',
        ]);

        $this->assertEquals(200, $variable['headers']['status-code']);
        $this->assertNotEmpty($variable['body']['$id']);
        $this->assertEquals('functionKey1Updated', $variable['body']['key']);
        $this->assertEquals('functionValue1Updated', $variable['body']['value']);
        $this->assertEquals(false, $variable['body']['secret']);
        ...
        $secretVariable = $this->updateVariable($functionId, $secretVariable['body']['$id'], [
            'key' => 'functionKey3',
            'value' => 'functionValue3Updated',
        ]);
        ...
        $temp = $this->updateVariable($functionId, $secretVariable['body']['$id'], [
            'key' => 'functionKey3',
            'secret' => false,
        ]);
        ...
        // list variables
        $variables = $this->listVariables($functionId);
        ...
        // delete variable
        $this->deleteVariable($functionId, $variable['body']['$id']);
        $this->deleteVariable($functionId, $variable2['body']['$id']);
        $this->deleteVariable($functionId, $secretVariable['body']['$id']);
