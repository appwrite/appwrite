...
class DatabasesPermissionsTeamTest extends Scope
{
    ...
    public function createCollections($teams)
    {
        ...
        $collection1 = $this->client->call(Client::METHOD_POST, '/documentsdb/' . $this->databaseId . '/collections', $this->getServerHeader(), [
    ...
    public function testSetupDatabase(): array
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, '/documentsdb/' . $this->databaseId . '/collections/' . $this->collections['collection1'] . '/documents', $this->getServerHeader(), [
        ...
        $response = $this->client->call(Client::METHOD_POST, '/documentsdb/' . $this->databaseId . '/collections/' . $this->collections['collection2'] . '/documents', $this->getServerHeader(), [
            'documentId' => ID::unique(),
            'data' => [
                'title' => 'Ipsum',
            ],
    ...
    {
        $documents = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $this->databaseId . '/collections/' . $collection  . '/documents', [
    ...
    {
        $documents = $this->client->call(Client::METHOD_POST, '/documentsdb/' . $this->databaseId . '/collections/' . $collection  . '/documents', [
            'origin' => 'http://localhost',
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'cookie' => 'a_session_' . $this->getProject()['$id'] . '=' . $users[$user]['session'],
