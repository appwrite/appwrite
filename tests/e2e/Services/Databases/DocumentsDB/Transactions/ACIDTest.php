...
class ACIDTest extends Scope
{
    ...
    public function testAtomicity(): void
    {
        ...
        $doc1 = $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
     ...
     */
    // no consistency test -> documentsdb is schemaless
    ...
    public function testIsolation(): void
    {
        ...
        $transaction1 = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
        ...
        $document = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/shared_counter", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testDurability(): void
    {
        ...
        $allDocs = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $document1 = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/durable_doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $document2 = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/durable_doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $update = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/durable_doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
