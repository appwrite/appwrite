...
trait TransactionsBase
{
    ...
    public function testCreate(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testCreateOperations(): void
    {
        ...
        // Create transaction
        $transaction = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_POST, "/documentsdb/transactions/{$transactionId}/operations", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testCommit(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/{$transactionId}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $documents = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testTransactionExpiration(): void
    {
        ...
        $txnDetails = $this->client->call(Client::METHOD_GET, "/documentsdb/transactions/{$transactionId}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
    ...
    public function testConcurrentTransactionConflicts(): void
    {
        ...
        $txn1 = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));

        $txn2 = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $this->client->call(Client::METHOD_POST, "/documentsdb/transactions/{$transactionId1}/operations", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, "/documentsdb/transactions/{$transactionId2}/operations", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response1 = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/{$transactionId1}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response2 = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/{$transactionId2}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $doc = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/shared_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testDeleteDocumentDuringTransaction(): void
    {
        ...
        $this->client->call(Client::METHOD_POST, "/documentsdb/transactions/{$transactionId}/operations", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_DELETE, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/target_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
    ...
    public function testBulkOperations(): void
    {
        ...
        for ($i = 1; $i <= 5; $i++) {
            $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
                'x-appwrite-key' => $this->getProject()['apiKey']
            ]), [
    ...
    public function testPartialFailureRollback(): void
    {
        ...
        $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/indexes", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testDoubleCommitRollback(): void
    {
        ...
        $transaction2 = $this->client->call(Client::METHOD_POST, '/documentsdb/transactions', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        // First rollback
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/{$transactionId2}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testOperationsOnNonExistentDocuments(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_POST, "/documentsdb/transactions/{$transactionId2}/operations", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testCreateDocument(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_from_route", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testUpdateDocument(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_to_update", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_to_update", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testUpsertDocument(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PUT, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_upsert", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Document should not exist outside transaction yet
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_upsert", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testDeleteDocument(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_DELETE, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_to_delete", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_to_delete", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkCreate(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/bulk_create_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        for ($i = 1; $i <= 3; $i++) {
            $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/bulk_create_{$i}", array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
    ...
    public function testBulkUpsert(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/bulk_upsert_existing", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/bulk_upsert_new", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkDelete(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_DELETE, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testMixedSingleOperations(): void
    {
        ...
        $existingDoc = $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response1 = $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response2 = $this->client->call(Client::METHOD_POST, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response3 = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/existing_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response4 = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/new_doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response5 = $this->client->call(Client::METHOD_DELETE, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/new_doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response6 = $this->client->call(Client::METHOD_PUT, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/upserted_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/new_doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/upserted_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/existing_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/new_doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testMixedOperations(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/mixed_doc1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/mixed_doc2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkUpdateWithTransactionAwareQueries(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/txn_doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/txn_doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        for ($i = 1; $i <= 3; $i++) {
            $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/existing_{$i}", array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
    ...
    public function testBulkUpdateMatchingUpdatedDocuments(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_3", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkDeleteMatchingCreatedDocuments(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/temp_1", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/temp_2", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkDeleteMatchingUpdatedDocuments(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_4", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_4", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        foreach ([1, 3, 5] as $i) {
            $response = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/doc_{$i}", array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
    ...
    public function testIncrementDecrementOperations(): void
    {
        ...
        // Verify final values
        $doc = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/counter_doc", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testIncrementDecrementEndpointsWithTransaction(): void
    {
        ...
        $decrementResponse = $this->client->call(
            Client::METHOD_PATCH,
            "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/joe/balance/decrement",
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
        ...
        $incrementResponse = $this->client->call(
            Client::METHOD_PATCH,
            "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/jane/balance/increment",
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
        ...
        $commitResponse = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/{$transactionId}", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'commit' => true
        ...
        // Verify final values
        $joe = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/joe", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));

        $jane = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents/jane", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testBulkUpdateOperations(): void
    {
        ...
        // Verify updates
        $docs = $this->client->call(Client::METHOD_GET, "/documentsdb/{$databaseId}/collections/{$collectionId}/documents", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testCommitRollbackValidation(): void
    {
        ...
        $response = $this->client->call(Client::METHOD_PATCH, "/documentsdb/transactions/invalid_id", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
