...
class DatabasesConsoleClientTest extends Scope
{
    ...
    public function testCreateCollection(): array
    {
         ...
         */
        $database = $this->client->call(Client::METHOD_PUT, '/documentsdb/' . $databaseId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
        ...
        $tvShows = $this->client->call(Client::METHOD_POST, '/documentsdb/' . $databaseId . '/collections', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'collectionId' => ID::unique(),
         ...
         */
        $database = $this->client->call(Client::METHOD_PUT, '/documentsdb/' . $databaseId . '/collections/' . $movies['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'name' => 'Movies',
    ...
    public function testGetCollection(array $data)
    {
         ...
         */
        $collection = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $databaseId . '/collections/' . $moviesCollectionId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testUpdateCollection(array $data)
    {
         ...
         */
        $collection = $this->client->call(Client::METHOD_PUT, '/documentsdb/' . $databaseId . '/collections/' . $moviesCollectionId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'name' => 'Movies Updated',
    ...
    public function testDeleteCollection(array $data)
    {
         ...
         */
        $response = $this->client->call(Client::METHOD_DELETE, '/documentsdb/' . $databaseId . '/collections/' . $tvShowsId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testGetDatabaseUsage(array $data)
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $databaseId . '/usage', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id']
        ], $this->getHeaders()), [
            'range' => '32h'
    ...
    public function testGetCollectionUsage(array $data)
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $databaseId . '/collections/' . $data['moviesId'] . '/usage', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id']
        ], $this->getHeaders()), [
            'range' => '32h'
        ...
        $response = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $databaseId . '/collections/randomCollectionId/usage', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id']
        ], $this->getHeaders()), [
            'range' => '24h'
    ...
    public function testGetCollectionLogs(array $data)
    {
         ...
         * Test for SUCCESS
         */
        $logs = $this->client->call(Client::METHOD_GET, '/documentsdb/' . $databaseId . '/collections/' . $data['moviesId'] . '/logs', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
