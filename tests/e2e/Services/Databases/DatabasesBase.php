...
trait DatabasesBase
{
    ...
    public function testUpdateDocument(array $data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($document['body']['$createdAt']));
        $this->assertEquals(true, $this->datetimeValidator->isValid($document['body']['birthDay']));
