...
trait DatabasesBase
{
    ...
    public function testConsoleProject(array $data): void
    {
        ...
        $response = $this->client->call(
            Client::METHOD_GET,
            '/databases/console/tablesdb/tables/' . $data['moviesId'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
    ...
    public function testDisableTable(array $data): void
    {
         ...
         * Test for SUCCESS
         */
        $response = $this->client->call(Client::METHOD_PUT, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        if ($this->getSide() === 'client') {
            $responseCreateDocument = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()), [
                'rowId' => ID::unique(),
            ...
            $responseListDocument = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
            ...
            $responseGetDocument = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/someID', array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
    ...
    public function testCreateColumns(array $data): array
    {
        ...
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $description = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $tagline = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $releaseYear = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $duration = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $actors = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $datetime = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/datetime', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $relationship = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $integers = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $movies = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
    ...
    {
        $databaseId = $data['databaseId'];
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
    ...
    public function testPatchColumn(array $data): void
    {
        ...
        $attribute = $this->client->call(Client::METHOD_POST, '/databases/'.$databaseId.'/tablesdb/tables/'.$table['body']['$id'].'/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $index = $this->client->call(Client::METHOD_POST, '/databases/'.$databaseId.'/tablesdb/tables/'.$table['body']['$id'].'/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
         ...
         */
        $attribute = $this->client->call(Client::METHOD_PATCH, '/databases/'.$databaseId.'/tablesdb/tables/'.$table['body']['$id'].'/columns/string/'.$attribute['body']['key'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
    ...
    public function testUpdateColumnEnum(): void
    {
        ...
        $players = $this->client->call(Client::METHOD_POST, '/databases/' . $database['body']['$id'] . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $attribute = $this->client->call(Client::METHOD_POST, '/databases/' . $database['body']['$id'] . '/tablesdb/tables/' . $players['body']['$id'] . '/columns/enum', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $attribute = $this->client->call(Client::METHOD_PATCH, '/databases/' . $database['body']['$id'] . '/tablesdb/tables/' . $players['body']['$id'] . '/columns/enum/' . $attribute['body']['key'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
    ...
    public function testColumnResponseModels(array $data): array
    {
        ...
        $columnsPath = "/databases/" . $databaseId . "/tablesdb/tables/{$tableId}/columns";
         ...
         * Test for FAILURE
         */
        $badEnum = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/enum', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testCreateIndexes(array $data): array
    {
        ...
        $titleIndex = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $releaseYearIndex = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $releaseWithDate1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $releaseWithDate2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Test for failure
        $fulltextReleaseYear = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $noAttributes = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $duplicates = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $tooLong = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $fulltextArray = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $actorsArray = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $twoLevelsArray = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $unknown = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $index1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
        ...
        $index2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
    ...
    public function testGetIndexByKeyWithLengths(array $data): void
    {
        ...
        $create = $this->client->call(Client::METHOD_POST, "/databases/{$databaseId}/tablesdb/tables/{$tableId}/indexes", [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $index = $this->client->call(Client::METHOD_GET, "/databases/{$databaseId}/tablesdb/tables/{$tableId}/indexes/lengthTestIndex", [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]);
    ...
    {
        $databaseId = $data['databaseId'];
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey'],
        ]), [
    ...
    {
        $databaseId = $data['databaseId'];
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row4 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
    ...
    public function testUpsertRow(array $data): void
    {
        $databaseId = $data['databaseId'];
        $rowId = ID::unique();
        $row = $this->client->call(Client::METHOD_PUT, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $rowId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $row = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $rowId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $row = $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $rowId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $person = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $library = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $relation = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/columns/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $libraryName = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $library['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // upserting values
        $rowId = ID::unique();
        $person1 = $this->client->call(Client::METHOD_PUT, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows/'.$rowId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $rows = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $person1 = $this->client->call(Client::METHOD_PUT, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows/'.ID::unique(), array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $deleteResponse = $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $rowId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
    ...
    {
        $databaseId = $data['databaseId'];
        $rows = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $patchNull = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/columns/string/description', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $rowsPaginated = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $row1['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testGetRow(array $data): void
    {
        ...
        foreach ($data['rows'] as $row) {
            $response = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $row['$tableId'] . '/rows/' . $row['$id'], array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()));
    ...
    public function testListRowsAfterPagination(array $data): array
    {
         ...
         */
        $base = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    {
        $databaseId = $data['databaseId'];
        $row = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $row = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $response = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
    ...
    public function testDeleteRow(array $data): array
    {
        ...
        $row = $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testInvalidRowStructure(): void
    {
        ...
        $email = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/email', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $enum = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/enum', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $ip = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/ip', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $url = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/url', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $range = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $floatRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/float', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $probability = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/float', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $upperBound = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $lowerBound = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $invalidRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
        ...
        $defaultArray = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json', 'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
            'key' => 'defaultArray',
        ...
        $defaultRequired = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $enumDefault = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/enum', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $enumDefaultStrict = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/enum', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $goodDatetime = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/datetime', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $datetimeDefault = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/datetime', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $goodEmail = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodEnum = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodIp = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodUrl = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodFloatRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $goodProbability = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $notTooHigh = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $notTooLow = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badEmail = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badEnum = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badIp = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badUrl = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badFloatRange = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badProbability = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $tooHigh = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $tooLow = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $badTime = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => 'unique()',
    ...
    public function testEnforceTableAndRowPermissions(): void
    {
        ...
        $attribute = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
        ...
        $rowsUser1 = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $row3GetWithCollectionRead = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $row3['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $row3GetWithDocumentRead = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $row3['body']['$id'], [
            'origin' => 'http://localhost',
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ...
        $row2GetFailure = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $row2['body']['$id'], [
            'origin' => 'http://localhost',
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'cookie' => 'a_session_' . $this->getProject()['$id'] . '=' . $session2,
        ...
        $rowsUser2 = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', [
            'origin' => 'http://localhost',
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'cookie' => 'a_session_' . $this->getProject()['$id'] . '=' . $session2,
    ...
    public function testEnforceTablePermissions(): void
    {
        ...
        $this->client->call(CLient::METHOD_PUT, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId, [
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ], [
    ...
    {
        $databaseId = $data['databaseId'];
        $uniqueIndex = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // test for failure
        $duplicate = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        // Test for exception when updating row to conflict
        $duplicate = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $row['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
    ...
    public function testPersistentCreatedAt(array $data): array
    {
        ...
        $row = $this->client->call(Client::METHOD_POST, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['moviesId'] . '/rows', $headers, [
            'rowId' => ID::unique(),
            'data' => [
        ...
        $row = $this->client->call(Client::METHOD_PATCH, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['moviesId'] . '/rows/' . $rowId, $headers, [
            'data' => [
    ...
    public function testUpdatePermissionsWithEmptyPayload(): array
    {
        ...
        // create attribute
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $moviesId . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // add row
        $row = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $moviesId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $moviesId . '/rows/' . $id, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'permissions' => [
        ...
        // remove table
        $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $moviesId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testColumnBooleanDefault(array $data): void
    {
        ...
        $true = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/boolean', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $false = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/boolean', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testOneToOneRelationship(array $data): array
    {
        ...
        $attribute = $this->client->call(Client::METHOD_GET, "/databases/{$databaseId}/tablesdb/tables/{$person['body']['$id']}/columns/library", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
        ...
        $person1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $person2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $response = $this->client->call(Client::METHOD_DELETE, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/columns/library', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
        ...
        $person1 = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $person['body']['$id'] . '/rows/' . $person1['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
    ...
    public function testOneToManyRelationship(array $data): array
    {
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $personCollection . '/columns/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $libraryCollectionResponse = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $libraryCollection, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
        ...
        $attribute = $this->client->call(Client::METHOD_GET, "/databases/{$databaseId}/tablesdb/tables/{$personCollection}/columns/libraries", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]));
        ...
        $person2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $personCollection . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => 'person10',
        ...
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $personCollection . '/rows/' . $person2['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $libraryCollection . '/rows/library11', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $response = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $personCollection . '/columns/libraries/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
    ...
    public function testManyToOneRelationship(array $data): array
    {
        ...
        // Create album table
        $albums = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $albums['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create artist table
        $artists = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $artists['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create relationship
        $response = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $albums['body']['$id'] . '/columns/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create album
        $album = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $albums['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => 'album1',
        ...
        $album = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $albums['body']['$id'] . '/rows/album1', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $artist = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $artists['body']['$id'] . '/rows/' . $album['body']['artist']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
    ...
    public function testManyToManyRelationship(array $data): array
    {
        ...
        // Create sports table
        $sports = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $sports['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create player table
        $players = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $players['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create relationship
        $response = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $sports['body']['$id'] . '/columns/relationship', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create sport
        $sport = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $sports['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => 'sport1',
        ...
        $sport = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $sports['body']['$id'] . '/rows/sport1', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
        ...
        $player = $this->client->call(Client::METHOD_GET, '/databases/' . $databaseId . '/tablesdb/tables/' . $players['body']['$id'] . '/rows/' . $sport['body']['players'][0]['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
    ...
    {
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['personCollection'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
    ...
    public function testSelectQueries(array $data): void
    {
        ...
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['personCollection'] . '/rows/' . $row['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'queries' => [
    ...
    public function testOrQueries(): void
    {
        ...
        // Create Collection
        $presidents = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $firstName = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $lastName = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $presidents['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testNotContains(): void
    {
        ...
        // Create Attributes
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $genre = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $movies['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testNotSearch(): void
    {
        ...
        // Create Collection
        $books = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $description = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/indexes', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $books['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testNotBetween(): void
    {
        ...
        // Create Collection
        $products = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $name = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $price = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/columns/float', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $products['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testNotStartsWith(): void
    {
        ...
        // Create Collection
        $employees = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $name = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $department = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $employees['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testNotEndsWith(): void
    {
        ...
        // Create Collection
        $files = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $filename = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $type = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $files['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testCreatedBefore(): void
    {
        ...
        // Create Collection
        $posts = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $content = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $posts['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testCreatedAfter(): void
    {
        ...
        // Create Collection
        $events = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $name = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $description = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $events['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testUpdatedBefore(): void
    {
        ...
        // Create Collection
        $tasks = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $title = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $status = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        // Update first task
        sleep(1);
        $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows/' . $taskOneId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        sleep(1);
        $updatedTaskTwo = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows/' . $taskTwoId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        // Update third task
        sleep(1);
        $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows/' . $taskThreeId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $tasks['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testUpdatedAfter(): void
    {
        ...
        // Create Collection
        $orders = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        // Create Attributes
        $orderNumber = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $status = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row1 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row2 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $row3 = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        // Update first order
        sleep(1);
        $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows/' . $orderOneId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        sleep(1);
        $updatedOrderTwo = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows/' . $orderTwoId, array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'data' => [
        ...
        $rows = $this->client->call(
            Client::METHOD_GET,
            '/databases/' . $databaseId . '/tablesdb/tables/' . $orders['body']['$id'] . '/rows',
            array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()),
    ...
    public function testUpdateWithExistingRelationships(array $data): void
    {
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $table1 . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $table2 . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $row = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $table1 . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id']
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $update = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $table1 . '/rows/' . $row['body']['$id'], array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id']
        ], $this->getHeaders()), [
            'data' => [
    ...
    {
        $table = $this->client->call(Client::METHOD_POST, '/databases/' . $data['databaseId'] . '/tablesdb/tables', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $longtext = $this->client->call(Client::METHOD_POST, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['$id'] . '/columns/string', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        for ($i = 0; $i < 10; $i++) {
            $this->client->call(Client::METHOD_POST, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['$id'] . '/rows', array_merge([
                'content-type' => 'application/json',
                'x-appwrite-project' => $this->getProject()['$id'],
            ], $this->getHeaders()), [
                'rowId' => ID::unique(),
        ...
        $response = $this->client->call(Client::METHOD_GET, '/databases/' . $data['databaseId'] . '/tablesdb/tables/' . $data['$id'] . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
    ...
    public function testIncrementColumn(): void
    {
        ...
        $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/columns/integer', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
            'x-appwrite-key' => $this->getProject()['apiKey']
        ]), [
        ...
        $doc = $this->client->call(Client::METHOD_POST, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()), [
            'rowId' => ID::unique(),
        ...
        $inc = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/count/increment", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]));
        ...
        // Verify count = 6
        $get = $this->client->call(Client::METHOD_GET, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $inc2 = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/count/increment", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), [
            'value' => 4
        ...
        $get2 = $this->client->call(Client::METHOD_GET, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders()));
        ...
        $err = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/count/increment", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), ['max' => 8]);
        ...
        $notFound = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/unknown/increment", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]));
        ...
        $inc3 = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/count/increment", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), [
            'value' => 0
    ...
    public function testDecrementColumn(): void
    {
        ...
        $dec = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $rowId . '/count/decrement', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]));
        ...
        $dec2 = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $rowId . '/count/decrement', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), [
            'value' => 3
        ...
        $err = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $rowId . '/count/decrement', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), ['min' => 7]);
        $this->assertEquals(400, $err['headers']['status-code']);
        ...
        $typeErr = $this->client->call(Client::METHOD_PATCH, '/databases/' . $databaseId . '/tablesdb/tables/' . $tableId . '/rows/' . $rowId . '/count/decrement', array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), ['value' => 'not-a-number']);
        ...
        // Test decrement with value 0
        $inc3 = $this->client->call(Client::METHOD_PATCH, "/databases/$databaseId/tablesdb/tables/$tableId/rows/$rowId/count/decrement", array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ]), [
            'value' => 0
