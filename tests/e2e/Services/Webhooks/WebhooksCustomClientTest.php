...
class WebhooksCustomClientTest extends Scope
{
    ...
    public function testCreateAccount(): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($webhook['data']['registration']));
    ...
    public function testCreateAccountSession($data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($webhook['data']['expire']));
    ...
    public function testUpdateTeamMembership($data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($webhook['data']['joined']));
