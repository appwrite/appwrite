...
trait WebhooksBase
{
    ...
    public function testCreateBucketFile(array $data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($webhook['data']['$createdAt']));
    ...
    public function testCreateTeamMembership($data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($webhook['data']['invited']));
