...
final class ProjectsConsoleClientTest extends Scope
{
    ...
    public function testProjectMcpLastAccessAt(): void
    {
        ...
        $this->assertSame('', $project['body']['mcpLastAccessAt']);

        $consoleHeaders = array_merge([
            'content-type' => 'application/json',
            'x-appwrite-project' => $this->getProject()['$id'],
        ], $this->getHeaders());
        ...
        $response = $this->client->call(Client::METHOD_GET, '/projects/' . $projectId, $consoleHeaders);
        $this->assertEquals(200, $response['headers']['status-code']);
        ...
        $response = $this->client->call(Client::METHOD_GET, '/projects/' . $projectId, $consoleHeaders);
        $this->assertEquals(200, $response['headers']['status-code']);
        $this->assertNotEmpty($response['body']['mcpLastAccessAt']);
        $this->assertNotFalse(\strtotime((string) $response['body']['mcpLastAccessAt']));
    }
