...
trait StorageBase
{
    public function testCreateBucketFile(): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($file['body']['$createdAt']));
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($largeFile['body']['$createdAt']));
    ...
    public function testGetBucketFile(array $data): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($file1['body']['$createdAt']));
