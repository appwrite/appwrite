...
trait TeamsBase
{
    public function testCreateTeam(): array
    {
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($response1['body']['$createdAt']));
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($response2['body']['$createdAt']));
        ...
        $this->assertEquals(true, $this->datetimeValidator->isValid($response3['body']['$createdAt']));
        /**
         * Test for FAILURE
         */
