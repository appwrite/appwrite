    ...
    public function testCreateUserNullName(): void
    {
        $endpoints = [
            ...
            ['path' => '/users/phpass', 'payload' => [
                'userId' => ID::unique(),
                'email' => 'phpass-null-name-' . \uniqid() . '@appwrite.io',
                'password' => '$P$Br387rwferoKN7uwHZqNMu98q3U8RO.',
                'name' => null,
            ]],
            ['path' => '/users/scrypt', 'payload' => [
                'userId' => ID::unique(),
                'email' => 'scrypt-null-name-' . \uniqid() . '@appwrite.io',
            ...
            ['path' => '/users/scrypt-modified', 'payload' => [
                'userId' => ID::unique(),
                'email' => 'scrypt-modified-null-name-' . \uniqid() . '@appwrite.io',
