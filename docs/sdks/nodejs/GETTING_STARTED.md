...
let promise = users.create(sdk.ID.unique(), email = 'email@example.com', phone = '+123456789', password = 'password', name = "Walter O'Brien");
...
try {
    let res = await users.create(sdk.ID.unique(), email = 'email@example.com', phone = '+123456789', password = 'password', name = "Walter O'Brien");
} catch(e) {
