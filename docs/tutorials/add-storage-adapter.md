...
### Add new adapter
Add a new storage adapter inside the `src/Storage/Device/` folder. Use one of the existing ones as a reference. The new adapter class should extend the `Device` class and implement all the required methods.
