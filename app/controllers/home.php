...
$utopia->get('/auth/signin')
    ...
    {
        $page = new View('../app/views/home/auth/signin.phtml');
...
$utopia->get('/auth/signup')
    ...
    ->action(function() use ($layout)
    {
        $page = new View('../app/views/home/auth/signup.phtml');
...
$utopia->get('/auth/recovery')
    ...
    {
        $page = new View('../app/views/home/auth/recovery.phtml');
...
$utopia->get('/auth/confirm')
    ...
    ->action(function() use ($layout)
    {
        $page = new View('../app/views/home/auth/confirm.phtml');
...
$utopia->get('/auth/join')
    ...
    ->action(function() use ($layout)
    {
        $page = new View('../app/views/home/auth/join.phtml');
...
$utopia->get('/auth/recovery/reset')
    ...
    ->action(function() use ($layout)
    {
        $page = new View('../app/views/home/auth/recovery/reset.phtml');
