...
App::get('/v1/functions')
    ...
    ->action(function (array $queries, string $search, Response $response, Database $dbForProject) {
        ...
        $response->dynamic(new Document([
            ...
            'total' => $dbForProject->count('functions', $filterQueries, (int) App::getEnv('_APP_LIMIT_COUNT', APP_LIMIT_COUNT)),
...
App::get('/v1/functions/:functionId/deployments')
    ...
    ->action(function (string $functionId, array $queries, string $search, Response $response, Database $dbForProject) {
        ...
        $total = $dbForProject->count('deployments', $filterQueries, (int) App::getEnv('_APP_LIMIT_COUNT', APP_LIMIT_COUNT));
...
App::get('/v1/functions/:functionId/executions')
    ...
    ->action(function (string $functionId, array $queries, string $search, Response $response, Database $dbForProject, string $mode) {
        ...
        $total = $dbForProject->count('executions', $filterQueries, (int) App::getEnv('_APP_LIMIT_COUNT', APP_LIMIT_COUNT));
