...
App::post('/v1/functions')
    ...
    ->label('audits.event', 'functions.create')
...
App::put('/v1/functions/:functionId')
    ...
    ->label('audits.event', 'functions.update')
    ->label('audits.resource', 'function/{response.$id}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::patch('/v1/functions/:functionId/deployments/:deploymentId')
    ...
    ->label('audits.event', 'functions.deployments.update')
...
App::delete('/v1/functions/:functionId')
    ...
    ->label('audits.event', 'functions.delete')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::post('/v1/functions/:functionId/deployments')
    ...
    ->label('audits.event', 'functions.deployments.create')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::delete('/v1/functions/:functionId/deployments/:deploymentId')
    ...
    ->label('audits.event', 'functions.deployments.delete')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::post('/v1/functions/:functionId/deployments/:deploymentId/builds/:buildId')
    ...
    ->label('scope', 'functions.write')
    ->label('event', 'functions.[functionId].deployments.[deploymentId].update')
    ->label('audits.event', 'functions.deployments.builds.create')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_KEY, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'functions')
...
App::post('/v1/functions/:functionId/variables')
    ...
    ->groups(['api', 'functions'])
    ->label('scope', 'functions.write')
    ->label('audits.event', 'functions.variables.create')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::put('/v1/functions/:functionId/variables/:variableId')
    ...
    ->groups(['api', 'functions'])
    ->label('scope', 'functions.write')
    ->label('audits.event', 'functions.variables.update')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::delete('/v1/functions/:functionId/variables/:variableId')
    ...
    ->groups(['api', 'functions'])
    ->label('scope', 'functions.write')
    ->label('audits.event', 'functions.variables.delete')
    ->label('audits.resource', 'function/{request.functionId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
