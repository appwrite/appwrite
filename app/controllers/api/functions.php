...
App::post('/v1/functions')
    ...
    ->param('execute', [], new ArrayList(new Text(64), APP_LIMIT_ATTRIBUTE_COUNT), 'An array of strings with execution permissions. By default no user is granted with any execute permissions. [learn more about permissions](https://appwrite.io/docs/permissions) and get a full list of available permissions. Maximum of 100 scopes are allowed, each 64 characters long.')
    ...
    ->param('events', [], new ArrayList(new WhiteList(array_keys(Config::getParam('events')), true), APP_LIMIT_ATTRIBUTE_COUNT), 'Events list. Maximum of 100 events are allowed.', true)
