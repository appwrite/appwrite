...
App::patch('/v1/functions/:functionId/deployments/:deploymentId')
    ...
    ->label('audits.resource', 'function/{request.functionId}/deployment/{request.deploymentId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::post('/v1/functions/:functionId/deployments')
    ...
    ->label('audits.resource', 'function/{request.functionId}/deployment/{response.$id}')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'functions')
...
App::post('/v1/functions/:functionId/deployments/:deploymentId/builds/:buildId')
    ...
    ->label('scope', 'functions.write')
    ->label('event', 'functions.[functionId].deployments.[deploymentId].update')
    ->label('audits.resource', 'function/{request.functionId}/deployment/{request.deploymentId}/build/{request.buildId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_KEY, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'functions')
