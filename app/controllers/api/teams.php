...
App::get('/v1/teams/:teamId')
    ...
    ->param('teamId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Team ID.', true, ['dbForProject'])
    ->inject('response')
    ->inject('dbForProject')
...
App::get('/v1/teams/:teamId/memberships/:membershipId')
    ...
    ->param('teamId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Team ID.', true, ['dbForProject'])
    ->param('membershipId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Membership ID.', true, ['dbForProject'])
    ->inject('response')
    ->inject('project')
    ->inject('dbForProject')
