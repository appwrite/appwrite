...
App::post('/v1/teams')
    ...
    ->param('teamId', '', new CustomId(), 'Team ID. Choose your own unique ID or generate a random ID with `ID.unique()`. Valid chars are a-z, A-Z, 0-9, period, hyphen, and underscore. Can\'t start with a special char. Max length is 36 chars.')
