...
App::post('/v1/teams')
    ...
    ->label('audits.event', 'teams.create')
...
App::put('/v1/teams/:teamId')
    ...
    ->label('scope', 'teams.write')
    ->label('audits.event', 'teams.update')
    ->label('audits.resource', 'team/{response.$id}')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_KEY, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'teams')
...
App::delete('/v1/teams/:teamId')
    ...
    ->label('scope', 'teams.write')
    ->label('audits.event', 'teams.delete')
...
App::post('/v1/teams/:teamId/memberships')
    ...
    ->label('audits.event', 'teams.memberships.create')
    ->label('audits.resource', 'team/{request.teamId}')
...
App::patch('/v1/teams/:teamId/memberships/:membershipId')
    ...
    ->label('scope', 'teams.write')
    ->label('audits.event', 'teams.memberships.update')
    ->label('audits.resource', 'team/{request.teamId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_KEY, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'teams')
...
App::patch('/v1/teams/:teamId/memberships/:membershipId/status')
    ...
    ->label('scope', 'public')
    ->label('audits.event', 'teams.memberships.status.update')
    ->label('audits.resource', 'team/{request.teamId}')
    ->label('audits.userId', '{request.userId}')
...
App::delete('/v1/teams/:teamId/memberships/:membershipId')
    ...
    ->label('scope', 'teams.write')
    ->label('audits.event', 'teams.memberships.delete')
    ->label('audits.resource', 'team/{request.teamId}')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_KEY, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'teams')
