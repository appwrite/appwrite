...
App::post('/v1/account/sessions')
    ...
    ->inject('audits')
    ->inject('usage')
    ->action(function ($email, $password, $duration, $request, $response, $dbForProject, $locale, $geodb, $audits, $usage) {
        /** @var Appwrite\Utopia\Request $request */
        /** @var Appwrite\Utopia\Response $response */
        /** @var Utopia\Database\Database $dbForProject */
...
App::post('/v1/account/sessions/magic-url')
    ...
    ->inject('events')
    ->inject('mails')
    ->action(function ($userId, $email, $url, $duration, $request, $response, $project, $dbForProject, $locale, $audits, $events, $mails) {
    /** @var Appwrite\Utopia\Request $request */
        /** @var Appwrite\Utopia\Response $response */
        /** @var Utopia\Database\Document $project */
        /** @var Utopia\Database\Database $dbForProject */
...
App::post('/v1/account/sessions/anonymous')
    ...
    ->inject('audits')
    ->inject('usage')
    ->action(function ($duration, $request, $response, $locale, $user, $project, $dbForProject, $geodb, $audits, $usage) {
        /** @var Appwrite\Utopia\Request $request */
        /** @var Appwrite\Utopia\Response $response */
        /** @var Utopia\Locale\Locale $locale */
        /** @var Utopia\Database\Document $user */
