...
App::post('/v1/account/sessions/email')
    ...
    ->label('scope', 'public')
    ->label('auth.type', 'emailPassword')
    ->label('audits.event', 'account.session.email.create')
...
App::post('/v1/account/sessions/magic-url')
    ...
    ->label('audits.event', 'account.session.magic-url.create')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('sdk.auth', [])
    ->label('sdk.namespace', 'account')
...
App::put('/v1/account/sessions/magic-url')
    ...
    ->label('scope', 'public')
    ->label('event', 'users.[userId].sessions.[sessionId].create')
    ->label('audits.event', 'account.session.update')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('usage.metric', 'sessions.{scope}.requests.create')
...
App::post('/v1/account/sessions/phone')
    ...
    ->label('audits.event', 'account.session.phone.create')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('sdk.auth', [])
    ->label('sdk.namespace', 'account')
...
App::post('/v1/account/sessions/anonymous')
    ...
    ->label('audits.event', 'account.session.anonymous.create')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('usage.metric', 'sessions.{scope}.requests.create')
...
App::patch('/v1/account/name')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.name.update')
    ->label('audits.resource', 'user/{response.$id}')
...
App::patch('/v1/account/password')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.password.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('audits.userId', '{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
...
App::patch('/v1/account/email')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.email.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
...
App::patch('/v1/account/phone')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.phone.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
...
App::patch('/v1/account/prefs')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.preferences.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
...
App::patch('/v1/account/status')
    ...
    ->label('scope', 'account')
    ->label('audits.event', 'account.status.update')
    ->label('audits.resource', 'user/{response.$id}')
...
App::delete('/v1/account/sessions/:sessionId')
    ...
    ->label('audits.event', 'account.session.delete')
    ->label('audits.resource', 'user/{user.$id}')
...
App::delete('/v1/account/sessions')
    ...
    ->label('scope', 'account')
    ->label('event', 'users.[userId].sessions.[sessionId].delete')
    ->label('audits.event', 'account.sessions.delete')
    ->label('audits.resource', 'user/{user.$id}')
    ->label('usage.metric', 'sessions.{scope}.requests.delete')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
...
App::post('/v1/account/recovery')
    ...
    ->label('audits.event', 'account.recovery.create')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
...
App::put('/v1/account/recovery')
    ...
    ->label('audits.event', 'account.recovery.update')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('audits.userId', '{response.userId}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
...
App::post('/v1/account/verification')
    ...
    ->label('audits.event', 'account.verification.create')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
...
App::put('/v1/account/verification')
    ...
    ->label('audits.event', 'account.verification.update')
    ->label('audits.resource', 'user/{response.userId}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_SESSION, APP_AUTH_TYPE_JWT])
    ->label('sdk.namespace', 'account')
