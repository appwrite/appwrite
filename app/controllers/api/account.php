...
App::get('/v1/account/logs')
    ...
    ->inject('geodb')
    ->inject('dbForProject')
    ->action(function (array $queries, Response $response, User $user, Locale $locale, Reader $geodb, Database $dbForProject) {
