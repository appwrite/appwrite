...
App::post('/v1/messaging/messages/email')
    ...
    ->param('topics', [], new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of Topic IDs.', true)
    ->param('users', [], new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of User IDs.', true)
    ->param('targets', [], new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of Targets IDs.', true)
    ->param('cc', [], new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'Array of target IDs to be added as CC.', true)
    ->param('bcc', [], new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'Array of target IDs to be added as BCC.', true)
...
App::patch('/v1/messaging/messages/email/:messageId')
    ...
    ->param('messageId', '', fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Message ID.', false, ['dbForProject'])
    ->param('topics', null, new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of Topic IDs.', true)
    ->param('users', null, new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of User IDs.', true)
    ->param('targets', null, new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'List of Targets IDs.', true)
    ...
    ->param('cc', null, new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'Array of target IDs to be added as CC.', true)
    ->param('bcc', null, new ArrayList(fn(Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength())), 'Array of target IDs to be added as BCC.', true)
    ->param('scheduledAt', null, new DatetimeValidator(requireDateInFuture: true), 'Scheduled delivery time for message in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. DateTime value must be in future.', true)
