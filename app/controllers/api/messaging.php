...
App::post('/v1/messaging/messages/push')
    ...
    ->param('image', '', new CompoundUID(), 'Image for push notification. Must be a compound bucket ID to file ID of a jpeg, png, or bmp image in Appwrite Storage. They should be formatted as <BUCKET_ID>:<FILE_ID>.', true)
...
App::patch('/v1/messaging/messages/push/:messageId')
    ...
    ->param('image', null, new CompoundUID(), 'Image for push notification. Must be a compound bucket ID to file ID of a jpeg, png, or bmp image in Appwrite Storage. They should be formatted as <BUCKET_ID>:<FILE_ID>.', true)
