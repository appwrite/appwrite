...
use Utopia\Database\Validator\Datetime as DatetimeConstants;
...
App::post('/v1/messaging/messages/email')
    ...
    ->param('scheduledAt', null, new Nullable(new DatetimeValidator(requireDateInFuture: true, precision: DatetimeConstants::PRECISION_MINUTES, offset: 60)), 'Scheduled delivery time for message in [ISO 8601](https://www.iso.org/iso-8601-date-and-time-format.html) format. DateTime value must be in future with precision in minutes.', true)
    ->inject('queueForEvents')
    ->inject('dbForProject')
