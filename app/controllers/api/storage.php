...
App::post('/v1/storage/buckets')
    ...
    ->param('antiVirus', true, new Boolean(), 'Is virus scanning enabled? For file size above ' . App::get('APP_LIMIT_ENCRYPTION',2000000) . ' AntiVirus scanning is skipped even if it\'s enabled', true)
    ->inject('response')
