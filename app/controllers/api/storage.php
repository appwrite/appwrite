...
App::get('/v1/storage/files/:fileId/preview')
    ...
    ->param('gravity', Image::GRAVITY_CENTER, new WhiteList([Image::GRAVITY_CENTER, Image::GRAVITY_TOP, Image::GRAVITY_TOP_LEFT, Image::GRAVITY_TOP_RIGHT, Image::GRAVITY_LEFT, Image::GRAVITY_RIGHT, Image::GRAVITY_BOTTOM_LEFT, Image::GRAVITY_BOTTOM, Image::GRAVITY_BOTTOM_RIGHT]), 'Image crop gravity', true)
