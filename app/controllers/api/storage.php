...
App::post('/v1/storage/buckets')
    ...
    ->param('allowedFileExtensions', [], new ArrayList(new Text(64), APP_LIMIT_ATTRIBUTE_COUNT), 'Allowed file extensions. Maximum of 100 extensions are allowed, each 64 characters long.', true)
