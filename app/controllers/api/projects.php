...
App::post('/v1/projects')
    ...
    ->param('projectId', '', new CustomId(), 'Unique Id. Choose your own unique ID or pass the string `unique()` to auto generate it. Valid chars are a-z, A-Z, 0-9, and non leading underscore, hyphen and dot. Max length is 36 chars.')
