...
App::get('/v1/projects/:projectId/webhooks/:webhookId')
    ...
    ->param('projectId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Project unique ID.', true, ['dbForProject'])
    ->param('webhookId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Webhook unique ID.', true, ['dbForProject'])
    ->inject('response')
    ->inject('dbForPlatform')
...
App::get('/v1/projects/:projectId/platforms/:platformId')
    ...
    ->param('projectId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Project unique ID.', true, ['dbForProject'])
    ->param('platformId', '', fn (Database $dbForProject) => new UID($dbForProject->getAdapter()->getMaxUIDLength()), 'Platform unique ID.', true, ['dbForProject'])
    ->inject('response')
    ->inject('dbForPlatform')
