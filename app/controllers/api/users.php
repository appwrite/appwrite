...
App::post('/v1/users')
    ...
    ->action(function (string $userId, ?string $email, ?string $phone, ?string $password, string $name, Response $response, Document $project, Database $dbForProject, Hooks $hooks, Event $queueForEvents) {
...
App::post('/v1/users/bcrypt')
    ...
    ->inject('hooks')
    ->inject('queueForEvents')
    ->action(function (string $userId, string $email, string $password, string $name, Response $response, Document $project, Database $dbForProject, Hooks $hooks, Event $queueForEvents) {
...
App::post('/v1/users/sha')
    ...
    ->inject('hooks')
    ->inject('queueForEvents')
    ->action(function (string $userId, string $email, string $password, string $passwordVersion, string $name, Response $response, Document $project, Database $dbForProject, Hooks $hooks, Event $queueForEvents) {
        $options = '{}';
...
App::post('/v1/users/scrypt')
    ...
    ->inject('hooks')
    ->inject('queueForEvents')
    ->action(function (string $userId, string $email, string $password, string $passwordSalt, int $passwordCpu, int $passwordMemory, int $passwordParallel, int $passwordLength, string $name, Response $response, Document $project, Database $dbForProject, Hooks $hooks, Event $queueForEvents) {
        $options = [
            'salt' => $passwordSalt,
            'costCpu' => $passwordCpu,
...
App::post('/v1/users/scrypt-modified')
    ...
    ->inject('hooks')
    ->inject('queueForEvents')
    ->action(function (string $userId, string $email, string $password, string $passwordSalt, string $passwordSaltSeparator, string $passwordSignerKey, string $name, Response $response, Document $project, Database $dbForProject, Hooks $hooks, Event $queueForEvents) {
