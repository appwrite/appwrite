...
App::post('/v1/users')
    ...
    ->label('audits.event', 'users.create')
...
App::post('/v1/users/bcrypt')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.bcrypt')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/md5')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.md5')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/argon2')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.argon2')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/sha')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.sha')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/phpass')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.phpass')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/scrypt')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.scrypt')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::post('/v1/users/scrypt-modified')
    ...
    ->label('event', 'users.[userId].create')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.create.scrypt-modified')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.create')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::patch('/v1/users/:userId/status')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.status.update')
    ->label('audits.resource', 'user/{response.$id}')
...
App::patch('/v1/users/:userId/verification')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.verification.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::patch('/v1/users/:userId/verification/phone')
    ...
    ->label('event', 'users.[userId].update.verification')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.verification.phone.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::patch('/v1/users/:userId/name')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.name.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('audits.userId', '{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
...
App::patch('/v1/users/:userId/password')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.password.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('audits.userId', '{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
...
App::patch('/v1/users/:userId/email')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.email.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('audits.userId', '{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
...
App::patch('/v1/users/:userId/phone')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.phone.update')
    ->label('audits.resource', 'user/{response.$id}')
    ->label('usage.metric', 'users.{scope}.requests.update')
    ->label('sdk.auth', [APP_AUTH_TYPE_KEY])
    ->label('sdk.namespace', 'users')
...
App::patch('/v1/users/:userId/verification')
    ...
    ->label('event', 'users.[userId].update.verification')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.verification.email.update')
...
App::delete('/v1/users/:userId/sessions/:sessionId')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.session.delete')
    ->label('audits.resource', 'user/{request.userId}')
...
App::delete('/v1/users/:userId/sessions')
    ...
    ->label('event', 'users.[userId].sessions.[sessionId].delete')
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.sessions.delete')
...
App::delete('/v1/users/:userId')
    ...
    ->label('scope', 'users.write')
    ->label('audits.event', 'users.delete')
    ->label('audits.resource', 'user/{request.userId}')
