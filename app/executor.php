...
App::post('/v1/runtimes')
    ...
    ->param('commands', [], new ArrayList(new Text(1024), APP_LIMIT_ATTRIBUTE_COUNT), 'Commands required to build the container. Maximum of 100 commands are allowed, each 1024 characters long.')
