...
const METRIC_MESSAGES_PROVIDER_TYPE = METRIC_MESSAGES . '.{providerType}';
const METRIC_MESSAGES_PROVIDER_TYPE_SENT  = METRIC_MESSAGES . '.{providerType}.sent';
const METRIC_MESSAGES_PROVIDER_TYPE_FAILED  = METRIC_MESSAGES . '.{providerType}.failed';
