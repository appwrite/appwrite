...
class Appwrite {
    ...
    functions = {
         ...
         * @returns {Promise}
         */
        getUsage: async <T extends unknown>(functionId: string, range?: string): Promise<T> => {
            if (typeof functionId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "functionId"');
            }
    ...
    projects = {
         ...
         * @returns {Promise}
         */
        create: async <T extends unknown>(name: string, teamId: string, description?: string, logo?: string, url?: string, legalName?: string, legalCountry?: string, legalState?: string, legalCity?: string, legalAddress?: string, legalTaxId?: string): Promise<T> => {
            if (typeof name === 'undefined') {
                throw new AppwriteException('Missing required parameter: "name"');
            }
         ...
         * @returns {Promise}
         */
        get: async <T extends unknown>(projectId: string): Promise<T> => {
         ...
         * @returns {Promise}
         */
        update: async <T extends unknown>(projectId: string, name: string, description?: string, logo?: string, url?: string, legalName?: string, legalCountry?: string, legalState?: string, legalCity?: string, legalAddress?: string, legalTaxId?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        delete: async <T extends unknown>(projectId: string, password: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateAuthLimit: async <T extends unknown>(projectId: string, limit: number): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        listDomains: async <T extends unknown>(projectId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        createDomain: async <T extends unknown>(projectId: string, domain: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getDomain: async <T extends unknown>(projectId: string, domainId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        deleteDomain: async <T extends unknown>(projectId: string, domainId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateDomainVerification: async <T extends unknown>(projectId: string, domainId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        listKeys: async <T extends unknown>(projectId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        createKey: async <T extends unknown>(projectId: string, name: string, scopes: string[]): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getKey: async <T extends unknown>(projectId: string, keyId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateKey: async <T extends unknown>(projectId: string, keyId: string, name: string, scopes: string[]): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        deleteKey: async <T extends unknown>(projectId: string, keyId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateOAuth2: async <T extends unknown>(projectId: string, provider: string, appId?: string, secret?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        listPlatforms: async <T extends unknown>(projectId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        createPlatform: async <T extends unknown>(projectId: string, type: string, name: string, key?: string, store?: string, hostname?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getPlatform: async <T extends unknown>(projectId: string, platformId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updatePlatform: async <T extends unknown>(projectId: string, platformId: string, name: string, key?: string, store?: string, hostname?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        deletePlatform: async <T extends unknown>(projectId: string, platformId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        listTasks: async <T extends unknown>(projectId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        createTask: async <T extends unknown>(projectId: string, name: string, status: string, schedule: string, security: boolean, httpMethod: string, httpUrl: string, httpHeaders?: string[], httpUser?: string, httpPass?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getTask: async <T extends unknown>(projectId: string, taskId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateTask: async <T extends unknown>(projectId: string, taskId: string, name: string, status: string, schedule: string, security: boolean, httpMethod: string, httpUrl: string, httpHeaders?: string[], httpUser?: string, httpPass?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        deleteTask: async <T extends unknown>(projectId: string, taskId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getUsage: async <T extends unknown>(projectId: string, range?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        listWebhooks: async <T extends unknown>(projectId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        createWebhook: async <T extends unknown>(projectId: string, name: string, events: string[], url: string, security: boolean, httpUser?: string, httpPass?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        getWebhook: async <T extends unknown>(projectId: string, webhookId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        updateWebhook: async <T extends unknown>(projectId: string, webhookId: string, name: string, events: string[], url: string, security: boolean, httpUser?: string, httpPass?: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
         ...
         * @returns {Promise}
         */
        deleteWebhook: async <T extends unknown>(projectId: string, webhookId: string): Promise<T> => {
            if (typeof projectId === 'undefined') {
                throw new AppwriteException('Missing required parameter: "projectId"');
            }
