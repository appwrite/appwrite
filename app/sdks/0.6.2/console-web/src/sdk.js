    ...
    window.Appwrite = function () {
        ...
        let bar = {
            ...
            get: function(x, y, z) {
                ...
                if(z === undefined) {
                    throw new Error('Missing required parameter: "z"');
                }
        ...
        let general = {
             ...
             */
            getCookie: function() {
                let path = '/mock/tests/general/get-cookie';
             ...
             */
            setCookie: function() {
                let path = '/mock/tests/general/set-cookie';
