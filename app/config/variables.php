    ...
    [
        ...
        'variables' => [
            ...
            [
                ...
                'description' => 'AWS S3 storage secret key. Required when the storage adapter is set to S3. You can get your secret key from your AWS console (this applies also to S3 S3 compatible storage like DigitalOcean).',
                'introduction' => '0.13.0',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'AWS S3 storage bucket. Required when storage adapter is set to S3. You can create buckets in your AWS console (this applies also to S3 S3 compatible storage like DigitalOcean).',
                'introduction' => '0.13.0',
                'default' => '',
                'required' => false,
                'question' => '',
