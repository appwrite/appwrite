    ...
    [
        ...
        'variables' => [
            ...
            [
                ...
                'description' => 'AWS S3 storage access key. Required when the storage adapter is set to S3. You can get your access key from your AWS console (this applies also to S3 compatible storage like DigitalOcean, Backblaze, Linode and Wasabi).',
                'introduction' => '0.13.0',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'AWS S3 storage secret key. Required when the storage adapter is set to S3. You can get your secret key from your AWS console (this applies also to S3 compatible storage like DigitalOcean, Backblaze, Linode and Wasabi).',
                'introduction' => '0.13.0',
                'default' => '',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'AWS S3 storage region. Required when storage adapter is set to S3. You can find your region info for your bucket from AWS console (this applies also to S3 compatible storage like DigitalOcean, Backblaze, Linode and Wasabi).',
                'introduction' => '0.13.0',
                'default' => 'us-east-1',
                'required' => false,
                'question' => '',
            ...
            [
                ...
                'description' => 'AWS S3 storage bucket. Required when storage adapter is set to S3. You can create buckets in your AWS console (this applies also to S3  compatible storage like DigitalOcean, Backblaze, Linode and Wasabi).',
                'introduction' => '0.13.0',
                'default' => '',
                'required' => false,
                'question' => '',
