...
return [
    ...
    'domains' => [
        ...
        'attributes' => [
            ...
            [
                '$id' => ID::custom('registrar'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
                'required' => false,
                'default' => null, // e.g. "appwrite" or "third_party"
                'array' => false,
                'filters' => [],
            ],
            [
                '$id' => ID::custom('nameservers'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => 255,
                'signed' => true,
        ...
        'indexes' => [
            ...
            [
                '$id' => ID::custom('_key_teamId_domain'),
                'type' => Database::INDEX_UNIQUE,
                'attributes' => ['teamId', 'domain'],
                'lengths' => [],
                'orders' => [],
            ],
            [
            ...
            [
                '$id' => ID::custom('_key_renewalPrice'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['renewalPrice'],
                'lengths' => [],
                'orders' => [],
            ],
            [
                '$id' => ID::custom('_key_renewal'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['renewal'],
                'lengths' => [],
                'orders' => [],
    ...
    'dnsRecords' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('dnsRecords'),
        'name' => 'DNS Records',
        'attributes' => [
            [
                '$id' => ID::custom('domainInternalId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                ...
                'format' => '',
                'size' => 0,
                'signed' => false,  // Port numbers are always positive
                'required' => false,
                'default' => 0,
                'array' => false,
                'filters' => [],
        ...
        'indexes' => [
            [
                '$id' => ID::custom('_key_domainInternalId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['domainInternalId'],
                'lengths' => [Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC],
            ],
            [
                '$id' => ID::custom('_key_domainId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['domainId'],
                'lengths' => [Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC],
            ],
            // New indexes based on allowed query attributes
            [
