...
$platformCollections = [
    ...
    'alerts' => [
        ...
        'indexes' => [
            ...
            [
                '$id' => ID::custom('_key_resource_read'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['resourceType', 'resourceId', 'read'],
                'lengths' => [64, Database::LENGTH_KEY, 0],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC, Database::ORDER_ASC],
            ],
            [
            ...
            [
                ...
                'lengths' => [0, 64, Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC, Database::ORDER_ASC],
            ],
            [
            ...
            [
                ...
                'type' => Database::INDEX_KEY,
                'attributes' => ['resourceType', 'resourceId', 'type'],
                'lengths' => [64, Database::LENGTH_KEY, 64],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC, Database::ORDER_ASC],
            ],
            [
                '$id' => ID::custom('_key_resource_channel'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['resourceType', 'resourceId', 'channel'],
                'lengths' => [64, Database::LENGTH_KEY, 64],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC, Database::ORDER_ASC],
            ],
            [
                '$id' => ID::custom('_key_resource_messageId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['resourceType', 'resourceId', 'messageId'],
                'lengths' => [64, Database::LENGTH_KEY, Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC, Database::ORDER_ASC],
            ],
        ],
    ],
