...
$platformCollections = [
    ...
    'alerts' => [
        ...
        'indexes' => [
            ...
            [
                '$id' => ID::custom('_key_userId_channel'),
                'type' => Database::INDEX_KEY,
            ...
            [
                '$id' => ID::custom('_key_userId_messageId'),
                'type' => Database::INDEX_KEY,
            ...
            [
                '$id' => ID::custom('_key_userId_projectId'),
                'type' => Database::INDEX_KEY,
            ...
            [
                '$id' => ID::custom('_key_userId_projectInternalId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['userId', 'projectInternalId'],
                'lengths' => [Database::LENGTH_KEY, Database::LENGTH_KEY],
                'orders' => [Database::ORDER_ASC, Database::ORDER_ASC],
            ],
        ],
