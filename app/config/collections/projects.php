...
return [
    ...
    'migrations' => [
        ...
        'attributes' => [
            ...
            [
                '$id' => ID::custom('destinationResourceId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                '$id' => ID::custom('destinationResourceInternalId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                '$id' => ID::custom('destinationResourceType'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
        ...
        'indexes' => [
            ...
            [
                '$id' => '_key_parentResourceInternalId',
                'type' => Database::INDEX_KEY,
            ...
            [
                '$id' => '_key_destinationResourceInternalId',
                'type' => Database::INDEX_KEY,
            ...
            [
                '$id' => '_key_destinationResourceType',
                'type' => Database::INDEX_KEY,
    ...
    'videos' => [
        ...
        'attributes' => [
            ...
            [
                '$id' => ID::custom('previewInternalId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                '$id' => ID::custom('videoFormatProfile'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                '$id' => ID::custom('videoFrameRateMode'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
    ...
    'videos_previews' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('videos_previews'),
        'name' => 'Videos Previews',
        'attributes' => [
            [
        ...
        'indexes' => [
            ...
            [
                '$id' => ID::custom('_key_videoInternalId'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['videoInternalId'],
                'lengths' => [],
                'orders' => [],
            ],
        ],
    ...
    'videos_renditions' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('videos_renditions'),
        'name' => 'Videos Renditions',
        'attributes' => [
            [
                '$id' => ID::custom('videoId'),
                'type' => Database::VAR_STRING,
            ...
            [
                '$id' => ID::custom('profileInternalId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                // Holds the parsed HLS stream list or the full DASH MPD, so this needs
                // room well beyond the 4096 the original schema allowed.
    ...
    'videos_renditions_segments' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('videos_renditions_segments'),
        'name' => 'Videos Renditions Segments',
        'attributes' => [
            [
                '$id' => ID::custom('renditionId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
            ...
            [
                '$id' => ID::custom('renditionInternalId'),
                'type' => Database::VAR_STRING,
                'format' => '',
                'size' => Database::LENGTH_KEY,
                'signed' => true,
        ...
        'indexes' => [
            ...
            [
                '$id' => ID::custom('_key_renditionInternalId_stream'),
                'type' => Database::INDEX_KEY,
                'attributes' => ['renditionInternalId', 'streamId'],
                'lengths' => [],
                'orders' => [],
            ],
        ],
    ...
    'videos_profiles' => [
        '$collection' => ID::custom(Database::METADATA),
        '$id' => ID::custom('videos_profiles'),
        'name' => 'Videos Profiles',
        'attributes' => [
            [
                '$id' => ID::custom('name'),
                'type' => Database::VAR_STRING,
