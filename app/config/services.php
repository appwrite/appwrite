...
return [
    ...
    'documentsDB' => [
        'key' => 'documentsDB',
        'name' => 'DocumentsDB',
        'subtitle' => 'The DocumentsDB service allows you to create structured collections of documents, query and filter lists of documents.',
        'description' => '/docs/services/databases.md',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://appwrite.io/docs/references/documentsdb',
        'tests' => false,
        'optional' => true,
        'icon' => '/images/services/databases.png',
    ...
    'tablesDB' => [
        ...
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://appwrite.io/docs/references/tablesdb',
        'tests' => false,
        'optional' => true,
        'icon' => '/images/services/databases.png',
        'platforms' => ['server', 'console'],
    ...
    'vectorsDB' => [
        'key' => 'vectorsDB',
        'name' => 'VectorsDB',
        'subtitle' => 'The VectorsDB service allows you to create vector collections, embeddings, indexes, and documents.',
        'description' => '/docs/services/databases.md',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://appwrite.io/docs/references/vectorsdb',
        'tests' => false,
        'optional' => true,
        'icon' => '/images/services/databases.png',
        'platforms' => ['server', 'console'],
    ...
    'webhooks' => [
        'key' => 'webhooks',
        'name' => 'Webhooks',
        'subtitle' => 'The Webhooks service allows you to configure event-driven HTTP callbacks for your project.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
    ...
    'tokens' => [
        'key' => 'tokens',
        'name' => 'Tokens',
        'subtitle' => 'The Tokens service allows you to create and manage resource tokens for project resources.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
    ...
    'presences' => [
        'key' => 'presences',
        'name' => 'Presences',
        'subtitle' => 'The Presences service allows you to create, query, and manage realtime presence state.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://appwrite.io/docs/references/presences',
        'tests' => false,
        'optional' => true,
        'icon' => '',
        'platforms' => ['client', 'server', 'console'],
    ...
    'assistant' => [
        'key' => 'assistant',
        'name' => 'Assistant',
        'subtitle' => 'The Assistant service allows Console users to ask assistant queries.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
        'docsUrl' => 'https://appwrite.io/docs/references/assistant',
        'tests' => false,
        'optional' => false,
        'icon' => '',
        'platforms' => ['console'],
