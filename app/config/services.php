...
return [
    ...
    'webhooks' => [
        'key' => 'webhooks',
        'name' => 'Webhooks',
        'subtitle' => 'The Webhooks service allows you to manage your project webhooks.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
    ...
    'tokens' => [
        'key' => 'tokens',
        'name' => 'Tokens',
        'subtitle' => 'The Tokens service allows you to create and manage resource tokens for secure file access.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
    ...
    'presences' => [
        'key' => 'presences',
        'name' => 'Presences',
        'subtitle' => 'The Presences service allows you to track and manage real-time user presence in your project.',
        'description' => '',
        'controller' => '', // Uses modules
        'sdk' => true,
        'docs' => true,
