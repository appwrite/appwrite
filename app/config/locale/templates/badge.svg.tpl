<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="{{totalWidth}}" height="20" role="img" aria-label="appwrite: {{message}}">
    <title>appwrite: {{message}}</title>
    ...
    <g clip-path="url(#r)">
        <rect width="77" height="20" fill="#FD366E"/>
        <rect x="77" width="100%" height="20" fill="{{colorCode}}"/>
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        ...
        <text aria-hidden="true" x="485" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)" textLength="480">appwrite</text>
        <text x="485" y="140" transform="scale(.1)" fill="#fff" textLength="480">appwrite</text>
        <text aria-hidden="true" x="820" y="150" text-anchor="start" fill="#010101" fill-opacity=".3" transform="scale(.1)">{{message}}</text>
        <text x="820" y="140" text-anchor="start" transform="scale(.1)" fill="#fff">{{message}}</text>
    </g>
</svg>
