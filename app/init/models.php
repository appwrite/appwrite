...
use Appwrite\Utopia\Response\Model\AnalyticsApp;
use Appwrite\Utopia\Response\Model\AnalyticsStats;
...
Response::setModel(new AnalyticsApp());
Response::setModel(new AnalyticsStats());
