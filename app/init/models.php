...
use Appwrite\Utopia\Response\Model\Sandbox;
...
Response::setModel(new Sandbox());
Response::setModel(new BaseList('Sandbox List', Response::MODEL_SANDBOX_LIST, 'sandboxes', Response::MODEL_SANDBOX));
