...
use Appwrite\Utopia\Response\Model\InstallationRequest;
...
use Appwrite\Utopia\Response\Model\OAuth2Cloudflare;
...
use Appwrite\Utopia\Response\Model\OAuth2HuggingFace;
use Appwrite\Utopia\Response\Model\OAuth2Kakao;
...
use Appwrite\Utopia\Response\Model\OAuth2Resend;
...
use Appwrite\Utopia\Response\Model\PolicyPasswordPwned;
...
Response::setModel(new BaseList('Installation Requests List', Response::MODEL_INSTALLATION_REQUEST_LIST, 'requests', Response::MODEL_INSTALLATION_REQUEST));
...
Response::setModel(new InstallationRequest());
...
Response::setModel(new OAuth2Cloudflare());
Response::setModel(new OAuth2HuggingFace());
...
Response::setModel(new OAuth2Resend());
Response::setModel(new OAuth2TikTok());
Response::setModel(new OAuth2Kakao());
...
Response::setModel(new PolicyPasswordPwned());
...
Response::setModel(new UsageEventList());
Response::setModel(new UsageGaugeList());
