...
use Appwrite\Utopia\Response\Model\Folder;
...
Response::setModel(new BaseList('Folders List', Response::MODEL_FOLDER_LIST, 'folders', Response::MODEL_FOLDER, paging: false));
