...
use Appwrite\Utopia\Response\Model\Explanation;
...
use Appwrite\Utopia\Response\Model\QueryPlanDetail;
...
Response::setModel(new QueryPlanDetail());
Response::setModel(new QueryPlanEntry());
Response::setModel(new Explanation());
