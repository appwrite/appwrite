...
App::setResource('schema', function ($utopia, $dbForProject, $project, $graphqlCache) {
    ...
    $attributes = function (int $limit, ?Document $last) use ($dbForProject, $projectId, &$types) {
...
}, ['utopia', 'dbForProject', 'project', 'graphqlCache']);
