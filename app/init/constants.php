...
const APP_LIMIT_ARRAY_SCOPES_SIZE = 300; // Default maximum of how many scope elements can there be in API parameter that expects array value
...
const APP_DATABASE_QUERY_MAX_VALUES_WORKER = 3000;
