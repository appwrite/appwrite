...
return function (Container $context): void {
    ...
    $context->set('deviceForVideos', fn ($project, Telemetry $telemetry) => new Device\Telemetry($telemetry, getDevice(APP_STORAGE_VIDEOS . '/app-' . $project->getId())), ['project', 'telemetry']);
