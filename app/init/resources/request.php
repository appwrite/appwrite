...
return function (Container $context): void {
    ...
    $context->set('deploymentsFactory', function (Jobs $jobs, array $platform) {
        return fn (Database $dbForProject, Document $project): Deployments => new Deployments($jobs, $dbForProject, $project, $platform, (int) System::getEnv('_APP_COMPUTE_BUILD_TIMEOUT', 900));
    }, ['jobs', 'platform']);
