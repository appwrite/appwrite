...
require_once __DIR__ . '/init/di-container.php';
...
$http->on(Constant::EVENT_START, function (Server $http) use ($payloadSize, $register) {
    ...
    // Initialize DI Container for dependency injection (PR #11564)
    $diContainer = createDIContainer();
    Http::setResource('di', fn () => $diContainer);

    go(function () use ($register, $app, $diContainer) {
