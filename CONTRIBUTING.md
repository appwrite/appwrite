...
**All PRs must include a commit message with a description of the changes!**
...
Appwrite is built to scale. Please keep in mind that the Appwrite stack can run in different environments and on different scales.
