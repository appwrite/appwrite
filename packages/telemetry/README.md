...
> [!IMPORTANT]
> This repository is a read-only mirror of [`packages/telemetry`](https://github.com/appwrite/appwrite/tree/main/packages/telemetry) in [appwrite/appwrite](https://github.com/appwrite/appwrite). Development happens there — please open issues and pull requests against appwrite/appwrite.
