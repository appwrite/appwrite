...
{
    /**
     * @deprecated Instruments are lazy by default; call Adapter::createUpDownCounter() instead. Removed in the next major.
     *
    ...
    public static function lazy(
        ...
        return $telemetry->createUpDownCounter($name, $unit, $description, $advisory);
    }
