...
class QueryTest extends TestCase
{
    ...
    public function testVectorMethodsAreVector(): void
    {
        ...
        $vectorMethods = array_filter(Method::cases(), fn (Method $m): bool => $m->isVector());
    ...
    {
        $aggMethods = array_filter(Method::cases(), fn (Method $m): bool => $m->isAggregate());
    ...
    {
        $joinMethods = array_filter(Method::cases(), fn (Method $m): bool => $m->isJoin());
