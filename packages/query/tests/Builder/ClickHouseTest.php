...
class ClickHouseTest extends TestCase
{
    ...
    public function testFinalWithWhenConditional(): void
    {
        $result = new Builder()
            ->from('events')
            ->when(true, fn (Builder $b): Builder => $b->final())
            ->build();
        $this->assertBindingCount($result);
        ...
        $result2 = new Builder()
            ->from('events')
            ->when(false, fn (Builder $b): Builder => $b->final())
            ->build();
    ...
    public function testSampleWithWhenConditional(): void
    {
        $result = new Builder()
            ->from('events')
            ->when(true, fn (Builder $b): Builder => $b->sample(0.5))
            ->build();
        $this->assertBindingCount($result);
        ...
        $result2 = new Builder()
            ->from('events')
            ->when(false, fn (Builder $b): Builder => $b->sample(0.5))
            ->build();
    ...
    public function testWhenTrueAddsPrewhere(): void
    {
        $result = new Builder()
            ->from('events')
            ->when(true, fn (Builder $b): Builder => $b->prewhere([Query::equal('type', ['click'])]))
            ->build();
        $this->assertBindingCount($result);
    ...
    public function testWhenFalseDoesNotAddPrewhere(): void
    {
        $result = new Builder()
            ->from('events')
            ->when(false, fn (Builder $b): Builder => $b->prewhere([Query::equal('type', ['click'])]))
            ->build();
        $this->assertBindingCount($result);
    ...
    public function testWhenNestedWithClickHouseFeatures(): void
    {
        $result = new Builder()
            ...
            ->when(
                ...
                fn (Builder $b): Builder => $b
                ->final()
                ->when(true, fn (Builder $b2): Builder => $b2->sample(0.5))
            )
            ->build();
        $this->assertBindingCount($result);
    ...
    public function testBeforeBuildCallback(): void
    {
        ...
        $result = new Builder()
            ->from('events')
            ->beforeBuild(function (Builder $b) use (&$callbackCalled): void {
                $callbackCalled = true;
    ...
    public function testAfterBuildCallback(): void
    {
        ...
        $result = new Builder()
            ->from('events')
            ->filter([Query::equal('status', ['active'])])
            ->afterBuild(function (Statement $r) use (&$capturedQuery): Statement {
