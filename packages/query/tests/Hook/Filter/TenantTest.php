...
namespace Utopia\Query\Tests\Hook\Filter;
...
class TenantTest extends TestCase
{
    ...
    public function testPermissionWithRoles(): void
    {
        $hook = new Permission(
            ...
            permissionsTable: fn (string $table): string => "mydb_{$table}_perms",
        );
    ...
    public function testPermissionCustomColumns(): void
    {
        $hook = new Permission(
            roles: ['admin'],
            permissionsTable: fn (string $table): string => 'acl',
            documentColumn: 'uid',
    ...
    public function testPermissionStaticTable(): void
    {
        $hook = new Permission(
            roles: ['user:123'],
            permissionsTable: fn (string $table): string => 'permissions',
        );
    ...
    public function testPermissionWithSingleColumn(): void
    {
        $hook = new Permission(
            roles: ['role:user'],
            permissionsTable: fn (string $table): string => "{$table}_perms",
            columns: ['salary'],
        );
    ...
    public function testPermissionInvalidColumnNameThrows(): void
    {
        ...
        new Permission(
            roles: ['admin'],
            permissionsTable: fn (string $table): string => 'perms',
    ...
    public function testPermissionInvalidTableNameThrows(): void
    {
        $hook = new Permission(
            roles: ['admin'],
            permissionsTable: fn (string $table): string => 'invalid table!',
        );
