...
* [**Account**](https://appwrite.io/docs/account) - Manage current user's account. Track and manage the user sessions, devices, and security audit log.
...
* [**Storage**](https://appwrite.io/docs/storage) - Manage storage files. Read, create, delete and preview files. Manipulate the preview of your files to fit your app perfectly. All files are scanned by ClamAV (an open source antivirus engine) and stored in a secure and encrypted way.
* [**Locale**](https://appwrite.io/docs/locale) - Track user's location, and manage your app's locale-based data.
