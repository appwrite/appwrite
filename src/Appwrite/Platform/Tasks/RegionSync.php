...
class RegionSync extends Action
{
    ...
    {
        $this
            ->desc('Region sync task, resend failed payloads and delete successful ones')
            ->inject('dbForConsole')
    ...
    public function action(Database $dbForConsole, Client $queueForSyncOutDelivery): void
    {
        ...
        Console::success(APP_NAME . ' Region sync v1 has started');

        $interval = (int) App::getEnv('_APP_SYNC_EDGE_INTERVAL', '20');
