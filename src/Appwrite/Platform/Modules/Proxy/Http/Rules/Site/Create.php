...
class Create extends Action
{
    ...
    public function action(string $domain, string $siteId, ?string $branch, Response $response, Document $project, CertificatesPublisher $publisherForCertificates, Event $queueForEvents, Database $dbForPlatform, Database $dbForProject, array $platform, Log $log)
    {
