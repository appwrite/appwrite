...
use Appwrite\Platform\Modules\Databases\Http\TablesDB\Tables\Rows\Explanation\Get as GetRowsExplanation;
...
class TablesDB extends Base
{
    ...
    private function registerRowActions(Service $service): void
    {
        ...
        $service->addAction(GetRowsExplanation::getName(), new GetRowsExplanation());
