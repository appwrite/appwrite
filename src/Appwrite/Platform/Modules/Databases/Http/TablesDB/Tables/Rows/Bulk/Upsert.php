...
class Upsert extends DocumentsUpsert
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('rows', [], fn (array $plan) => new ArrayList(new JSON\ObjectValidator(), $plan['databasesBatchSize'] ?? APP_LIMIT_DATABASE_BATCH), 'Array of row data as JSON objects. May contain partial rows.', false, ['plan'])
