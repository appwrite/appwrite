...
class Upsert extends DocumentUpsert
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('data', [], new JSON\ObjectValidator(), 'Row data as JSON object. Include all required columns of the row to be created or updated.', true, example: '{"username":"walter.obrien","email":"walter.obrien@example.com","fullName":"Walter O\'Brien","age":33,"isAdmin":false}')
