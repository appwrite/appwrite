...
class Update extends DocumentUpdate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('data', [], new JSON\ObjectValidator(), 'Row data as JSON object. Include only columns and value pairs to be updated.', true, example: '{"username":"walter.obrien","email":"walter.obrien@example.com","fullName":"Walter O\'Brien","age":33,"isAdmin":false}')
