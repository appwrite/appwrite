...
class Create extends CollectionCreate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('columns', [], new ArrayList(new JSON(), APP_LIMIT_ARRAY_PARAMS_SIZE), 'Array of column definitions to create. Each column should contain: key (string), type (string: string, integer, float, boolean, datetime, relationship, text, varchar, mediumtext, longtext, or format aliases email/url/ip/enum), size (integer, required for string/varchar), format (string, optional for string type: email/url/ip/enum), required (boolean, optional), default (mixed, optional), array (boolean, optional), and type-specific options.', true)
