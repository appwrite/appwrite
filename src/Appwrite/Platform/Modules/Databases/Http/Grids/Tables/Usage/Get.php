...
namespace Appwrite\Platform\Modules\Databases\Http\Grids\Tables\Usage;
...
class Get extends CollectionUsageGet
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/databases/:databaseId/grids/tables/:tableId/usage')
            ...
            ->label('sdk', new Method(
                ...
                group: null,
                name: self::getName(),
                description: '/docs/references/grids/get-table-usage.md',
                auth: [AuthType::ADMIN],
                responses: [
                    new SDKResponse(
