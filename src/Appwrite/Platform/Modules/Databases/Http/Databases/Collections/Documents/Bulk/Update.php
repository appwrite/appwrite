...
class Update extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('data', [], new JSON\ObjectValidator(), 'Document data as JSON object. Include only attribute and value pairs to be updated.', true, example: '{"username":"walter.obrien","email":"walter.obrien@example.com","fullName":"Walter O\'Brien","age":33,"isAdmin":false}')
