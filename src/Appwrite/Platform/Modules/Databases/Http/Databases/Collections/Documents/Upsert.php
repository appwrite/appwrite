...
class Upsert extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('data', [], new JSON\ObjectValidator(), 'Document data as JSON object. Include all required attributes of the document to be created or updated.', true, example: '{"username":"walter.obrien","email":"walter.obrien@example.com","fullName":"Walter O\'Brien","age":30,"isAdmin":false}')
