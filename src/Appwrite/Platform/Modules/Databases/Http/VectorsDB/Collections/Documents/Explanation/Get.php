...
namespace Appwrite\Platform\Modules\Databases\Http\VectorsDB\Collections\Documents\Explanation;
...
class Get extends DocumentExplanation
{
    ...
    {
        return 'getVectorsDBExplanation';
    }
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/vectorsdb/:databaseId/collections/:collectionId/documents/explanation')
            ...
            ->label('sdk', new Method(
                ...
                name: 'getExplanation',
                description: '/docs/references/vectorsdb/explanation-documents.md',
            ...
            ->param('queries', [], new ArrayList(new Text(MAX_VECTOR_QUERY_LENGTH), APP_LIMIT_ARRAY_PARAMS_SIZE), 'Array of query strings generated using the Query class provided by the SDK. Same shape as listDocuments.', true)
