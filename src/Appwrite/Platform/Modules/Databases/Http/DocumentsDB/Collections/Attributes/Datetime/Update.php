...
class Update extends DatetimeUpdate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/documentsdb/:databaseId/collections/:collectionId/attributes/datetime/:key')
            ...
            ->label('sdk', new Method(
                ...
                group: "attributes",
                name: self::getName(),
                description: '/docs/references/documentsdb/update-datetime-attribute.md',
                auth: [AuthType::KEY],
                responses: [
                    new SDKResponse(
