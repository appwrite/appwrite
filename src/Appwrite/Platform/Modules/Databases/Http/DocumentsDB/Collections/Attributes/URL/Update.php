...
namespace Appwrite\Platform\Modules\Databases\Http\DocumentsDB\Collections\Attributes\URL;
...
class Update extends URLUpdate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/documentsdb/:databaseId/collections/:collectionId/attributes/url/:key')
            ...
            ->label('sdk', new Method(
                ...
                group: "attributes",
                name: self::getName(),
                description: '/docs/references/documentsdb/update-url-attribute.md',
                auth: [AuthType::KEY],
                responses: [
                    new SDKResponse(
