...
namespace Appwrite\Platform\Modules\Databases\Http\DocumentsDB\Collections\Documents\Explanation;
...
class Get extends DocumentExplanation
{
    ...
    {
        return 'getDocumentsDBExplanation';
    }
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/documentsdb/:databaseId/collections/:collectionId/documents/explanation')
            ...
            ->label('sdk', new Method(
                ...
                name: 'getExplanation',
                description: '/docs/references/documentsdb/explanation-documents.md',
