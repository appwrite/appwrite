...
class Update extends PolygonUpdate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/documentsdb/:databaseId/collections/:collectionId/attributes/polygon/:key')
            ...
            ->label('sdk', new Method(
                ...
                group: "attributes",
                name: self::getName(),
                description: '/docs/references/documentsdb/update-polygon-attribute.md',
                auth: [AuthType::KEY],
                responses: [
                    new SDKResponse(
