...
class Update extends BooleanUpdate
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/documentsdb/:databaseId/collections/:collectionId/attributes/boolean/:key')
            ...
            ->label('sdk', new Method(
                ...
                group: "attributes",
                name: self::getName(),
                description: '/docs/references/documentsdb/update-boolean-attribute.md',
                auth: [AuthType::KEY],
                responses: [
                    new SDKResponse(
