...
class Upsert extends DocumentsUpsert
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('documents', [], fn (array $plan) => new ArrayList(new JSON\ObjectValidator(), $plan['databasesBatchSize'] ?? APP_LIMIT_DATABASE_BATCH), 'Array of document data as JSON objects. May contain partial documents.', false, ['plan'])
