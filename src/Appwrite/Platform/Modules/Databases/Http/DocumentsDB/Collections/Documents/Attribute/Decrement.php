...
class Decrement extends DecrementDocumentAttribute
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('value', 1, new Numeric(), 'Value to decrement the attribute by. The value must be a number.', true, example: '1')
            ->param('min', null, new Numeric(), 'Minimum value for the attribute. If the current value is lesser than this value, an exception will be thrown.', true, example: '0')
