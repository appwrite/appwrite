...
class Update extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->param('replyToEmail', null, new Nullable(new Email()), 'Email address to reply to. If not set, defaults to the sender email address.', true)
            ->param('replyToName', null, new Nullable(new Text(128)), 'Name of the reply to recipient. If not set, defaults to the sender name.', true)
