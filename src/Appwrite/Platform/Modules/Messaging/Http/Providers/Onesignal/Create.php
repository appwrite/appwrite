...
class Create extends Action
{
    ...
    {
        return 'createOnesignalProvider';
    }
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/messaging/providers/onesignal')
            ->desc('Create OneSignal provider')
            ...
            ->label('sdk', new Method(
                namespace: 'messaging',
                group: 'providers',
                name: 'createOnesignalProvider',
                description: '/docs/references/messaging/create-onesignal-provider.md',
    ...
    public function action(string $providerId, string $name, string $appId, string $restApiKey, ?bool $enabled, Event $queueForEvents, Database $dbForProject, Response $response)
    {
