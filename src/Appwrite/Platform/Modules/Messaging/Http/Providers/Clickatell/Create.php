...
class Create extends Action
{
    ...
    {
        return 'createClickatellProvider';
    }
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/messaging/providers/clickatell')
            ->desc('Create Clickatell provider')
            ...
            ->label('sdk', new Method(
                namespace: 'messaging',
                group: 'providers',
                name: 'createClickatellProvider',
                description: '/docs/references/messaging/create-clickatell-provider.md',
