...
namespace Appwrite\Platform\Modules\Messaging\Http\Providers\Clickatell;
...
class Update extends Action
{
    ...
    {
        return 'updateClickatellProvider';
    }
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/messaging/providers/clickatell/:providerId')
            ->desc('Update Clickatell provider')
            ...
            ->label('sdk', new Method(
                namespace: 'messaging',
                group: 'providers',
                name: 'updateClickatellProvider',
                description: '/docs/references/messaging/update-clickatell-provider.md',
            ...
            ->param('apiKey', '', new Text(0), 'Clickatell API Key.', true)
