...
namespace Appwrite\Platform\Modules\Messaging\Http\Providers\Vonage;
...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/messaging/providers/vonage')
    ...
    public function action(string $providerId, string $name, string $from, string $apiKey, string $apiSecret, ?bool $enabled, Event $queueForEvents, Database $dbForProject, Response $response)
    {
