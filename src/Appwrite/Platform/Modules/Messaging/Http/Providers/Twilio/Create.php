...
class Create extends Action
{
    ...
    public function __construct()
    {
        $this
            ...
            ->setHttpPath('/v1/messaging/providers/twilio')
    ...
    public function action(string $providerId, string $name, string $from, string $accountSid, string $authToken, ?bool $enabled, Event $queueForEvents, Database $dbForProject, Response $response)
    {
