...
class Create extends Action
{
    ...
    public function action(
        ...
        if (!$fileSizeValidator->isValid($fileSize) && $siteSizeLimit !== 0) { // Check if file size is exceeding allowed limit
            throw new Exception(Exception::GENERAL_ARGUMENT_INVALID, 'The file size is either not valid or exceeds the maximum allowed size. Please check the file or the value of the _APP_COMPUTE_SIZE_LIMIT environment variable.');
        }
