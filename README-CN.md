...
<p align="center">
    <h1>Appwrite</h1>
    <b>Appwrite 是一个开源的一站式开发平台。利用其内置的后端基础设施和 Web 托管服务，可在一个统一的平台内完成所有操作。</b>
    <br />
    <br />
</p>
...
要使用最简单的方式开始使用 Appwrite，您可以[**免费试用 Appwrite Cloud**](https://cloud.appwrite.io/)。在 Appwrite Cloud 您可以完全免费使用 Appwrite，而且我们不会收集您的信用卡信息。
