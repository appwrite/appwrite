...
* Remove legacy logging providers and require a provider DSN in `_APP_LOGGING_CONFIG` in [#12184](https://github.com/appwrite/appwrite/pull/12184). Currently, Appwrite supports Sentry DSNs.
