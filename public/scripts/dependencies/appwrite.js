  ...
  class Appwrite {
    constructor () {
      ...
      this.realtime = {
        ...
        createSocket: () => {
          ...
          if (
            ...
            ((_a = this.realtime.socket) === null || _a === void 0
              ? void 0
              : _a.readyState) > WebSocket.OPEN // Check if WebSocket is CLOSING (3) or CLOSED (4)
          ) {
            if (
              this.realtime.socket &&
              ((_b = this.realtime.socket) === null || _b === void 0
                ? void 0
                : _b.readyState) < WebSocket.CLOSING // Close WebSocket if it is CONNECTING (0) or OPEN (1)
            ) {
            ...
            this.realtime.socket.addEventListener('close', (event) => {
              ...
              if (
                ...
                (((_b =
                  (_a = this.realtime) === null || _a === void 0
                    ? void 0
                    : _a.lastMessage) === null || _b === void 0
                  ? void 0
                  : _b.type) === 'error' && // Check if last message was of type error
                  ((_c = this.realtime) === null || _c === void 0
                    ? void 0
                    : _c.lastMessage.data
            ...
            switch (message.type) {
              case 'connected':
                const cookie = JSON.parse(
                  (_a = window.localStorage.getItem('cookieFallback')) !==
                    null && _a !== void 0
                    ? _a
                    : '{}'
                )
                const session =
                  cookie === null || cookie === void 0
                    ? void 0
        ...
        cleanUp: (channels) => {
          this.realtime.channels.forEach((channel) => {
            if (channels.includes(channel)) {
              const found = Array.from(this.realtime.subscriptions).some(
                ([_key, subscription]) => {
      ...
      this.account = {
        ...
        updatePrefs: (prefs) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof prefs === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "prefs"'
              )
            }
            const path = '/account/prefs'
            const payload = {}
        ...
        updateRecovery: (userId, secret, password, passwordAgain) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            if (typeof passwordAgain === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "passwordAgain"'
              )
            }
            const path = '/account/recovery'
            const payload = {}
         ...
         * @returns {Promise}
         */
        createMagicURLSession: (email, url) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof email === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "email"'
            ...
            const path = '/account/sessions/magic-url'
            const payload = {}
            if (typeof email !== 'undefined') {
              payload.email = email
            }
        ...
        createOAuth2Session: (provider, success, failure, scopes) => {
          ...
          const path = '/account/sessions/oauth2/{provider}'.replace(
            '{provider}',
            provider
          )
          const payload = {}
        ...
        getSession: (sessionId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/account/sessions/{sessionId}'.replace(
              '{sessionId}',
              sessionId
            )
            const payload = {}
      ...
      this.database = {
         ...
         * @returns {Promise}
         */
        listCollections: (search, limit, offset, orderType) =>
          __awaiter(this, void 0, void 0, function * () {
            const path = '/database/collections'
            const payload = {}
         ...
         * @returns {Promise}
         */
        createCollection: (name, read, write, rules) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof name === 'undefined') {
              throw new AppwriteException('Missing required parameter: "name"')
            }
            ...
            if (typeof write === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "write"'
              )
            }
        ...
        getCollection: (collectionId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/database/collections/{collectionId}'.replace(
              '{collectionId}',
              collectionId
            )
            const payload = {}
         ...
         * @returns {Promise}
         */
        updateCollection: (collectionId, name, read, write, rules) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof collectionId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "collectionId"'
        ...
        listDocuments: (
          ...
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path =
              '/database/collections/{collectionId}/documents'.replace(
                '{collectionId}',
                collectionId
              )
            const payload = {}
      ...
      this.functions = {
         ...
         * @returns {Promise}
         */
        create: (name, execute, runtime, vars, events, schedule, timeout) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof name === 'undefined') {
              throw new AppwriteException('Missing required parameter: "name"')
            }
            if (typeof execute === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "execute"'
              )
            }
        ...
        get: (functionId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}'.replace(
              '{functionId}',
              functionId
            )
            const payload = {}
        ...
        listExecutions: (functionId, search, limit, offset, orderType) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}/executions'.replace(
              '{functionId}',
              functionId
            )
            const payload = {}
        ...
        getExecution: (functionId, executionId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}/executions/{executionId}'
        ...
        updateTag: (functionId, tag) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}/tag'.replace(
              '{functionId}',
              functionId
            )
            const payload = {}
         ...
         * @returns {Promise}
         */
        listTags: (functionId, search, limit, offset, orderType) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof functionId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "functionId"'
            ...
            const path = '/functions/{functionId}/tags'.replace(
              '{functionId}',
              functionId
            )
            const payload = {}
         ...
         * @returns {Promise}
         */
        createTag: (functionId, command, code) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof functionId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "functionId"'
        ...
        getTag: (functionId, tagId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}/tags/{tagId}'
              .replace('{functionId}', functionId)
              .replace('{tagId}', tagId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
        ...
        getUsage: (functionId, range) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/functions/{functionId}/usage'.replace(
              '{functionId}',
              functionId
            )
            const payload = {}
      ...
      this.health = {
        ...
        getQueueCertificates: () =>
          __awaiter(this, void 0, void 0, function * () {
            const path = '/health/queue/certificates'
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        getQueueFunctions: () =>
          __awaiter(this, void 0, void 0, function * () {
            const path = '/health/queue/functions'
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        getQueueWebhooks: () =>
          __awaiter(this, void 0, void 0, function * () {
            const path = '/health/queue/webhooks'
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        getStorageLocal: () =>
          __awaiter(this, void 0, void 0, function * () {
            const path = '/health/storage/local'
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
      ...
      this.projects = {
        ...
        get: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        updateAuthLimit: (projectId, limit) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/auth/limit'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        updateAuthStatus: (projectId, method, status) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/auth/{method}'
        ...
        listDomains: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/domains'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        getDomain: (projectId, domainId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/domains/{domainId}'
              .replace('{projectId}', projectId)
        ...
        updateDomainVerification: (projectId, domainId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/domains/{domainId}/verification'
              .replace('{projectId}', projectId)
              .replace('{domainId}', domainId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
        ...
        listKeys: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/keys'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
         ...
         * @returns {Promise}
         */
        createKey: (projectId, name, scopes) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof projectId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "projectId"'
         ...
         * @returns {Promise}
         */
        updateKey: (projectId, keyId, name, scopes) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof projectId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "projectId"'
        ...
        updateOAuth2: (projectId, provider, appId, secret) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/oauth2'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        listPlatforms: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/platforms'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        getPlatform: (projectId, platformId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/platforms/{platformId}'
              .replace('{projectId}', projectId)
        ...
        listTasks: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/tasks'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        createTask: (
          ...
          __awaiter(this, void 0, void 0, function * () {
            ...
            if (typeof security === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "security"'
              )
            }
            if (typeof httpMethod === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "httpMethod"'
              )
            }
            if (typeof httpUrl === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "httpUrl"'
              )
            }
            const path = '/projects/{projectId}/tasks'.replace(
              '{projectId}',
        ...
        getUsage: (projectId, range) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/usage'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        listWebhooks: (projectId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/projects/{projectId}/webhooks'.replace(
              '{projectId}',
              projectId
            )
            const payload = {}
        ...
        createWebhook: (
          ...
          __awaiter(this, void 0, void 0, function * () {
            ...
            if (typeof events === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "events"'
              )
            }
            if (typeof url === 'undefined') {
              throw new AppwriteException('Missing required parameter: "url"')
      ...
      this.storage = {
        ...
        getFileDownload: (fileId) => {
          ...
          const path = '/storage/files/{fileId}/download'.replace(
            '{fileId}',
            fileId
          )
          const payload = {}
        ...
        getFilePreview: (
          ...
          const path = '/storage/files/{fileId}/preview'.replace(
            '{fileId}',
            fileId
          )
          const payload = {}
        ...
        getFileView: (fileId) => {
          ...
          const path = '/storage/files/{fileId}/view'.replace(
            '{fileId}',
            fileId
          )
          const payload = {}
      ...
      this.teams = {
        ...
        getMemberships: (teamId, search, limit, offset, orderType) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/teams/{teamId}/memberships'.replace(
              '{teamId}',
              teamId
            )
            const payload = {}
        ...
        createMembership: (teamId, email, roles, url, name) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            if (typeof roles === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "roles"'
              )
            }
            if (typeof url === 'undefined') {
              throw new AppwriteException('Missing required parameter: "url"')
        ...
        updateMembershipRoles: (teamId, membershipId, roles) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/teams/{teamId}/memberships/{membershipId}'
        ...
        updateMembershipStatus: (teamId, membershipId, userId, secret) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/teams/{teamId}/memberships/{membershipId}/status'
              .replace('{teamId}', teamId)
              .replace('{membershipId}', membershipId)
            const payload = {}
            if (typeof userId !== 'undefined') {
      ...
      this.users = {
        ...
        get: (userId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}'.replace('{userId}', userId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        updateEmail: (userId, email) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/email'.replace('{userId}', userId)
            const payload = {}
            if (typeof email !== 'undefined') {
              payload.email = email
            }
        ...
        getLogs: (userId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/logs'.replace('{userId}', userId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        updateName: (userId, name) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/name'.replace('{userId}', userId)
            const payload = {}
            if (typeof name !== 'undefined') {
              payload.name = name
            }
        ...
        updatePassword: (userId, password) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/password'.replace('{userId}', userId)
            const payload = {}
            if (typeof password !== 'undefined') {
              payload.password = password
            }
        ...
        getPrefs: (userId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/prefs'.replace('{userId}', userId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        getSessions: (userId) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/sessions'.replace('{userId}', userId)
            const payload = {}
            const uri = new URL(this.config.endpoint + path)
            return yield this.call(
              'get',
        ...
        updateStatus: (userId, status) =>
          __awaiter(this, void 0, void 0, function * () {
            ...
            const path = '/users/{userId}/status'.replace('{userId}', userId)
            const payload = {}
            if (typeof status !== 'undefined') {
              payload.status = status
            }
         ...
         * @returns {Promise}
         */
        updateVerification: (userId, emailVerification) =>
          __awaiter(this, void 0, void 0, function * () {
            if (typeof userId === 'undefined') {
              throw new AppwriteException(
                'Missing required parameter: "userId"'
            ...
            const path = '/users/{userId}/verification'.replace(
              '{userId}',
              userId
            )
            const payload = {}
      ...
      return __awaiter(this, void 0, void 0, function * () {
        ...
        if (typeof window !== 'undefined' && window.localStorage) {
          headers['X-Fallback-Cookies'] =
            (_a = window.localStorage.getItem('cookieFallback')) !== null &&
            _a !== void 0
              ? _a
              : ''
        }
        ...
        try {
          ...
          if (
            (_b = response.headers.get('content-type')) === null ||
            _b === void 0
              ? void 0
              : _b.includes('application/json')
          ) {
