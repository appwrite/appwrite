...
RUN mkdir -R /storage/uploads && chown -Rf www-data.www-data /storage/uploads && chmod -Rf 0755 /storage/uploads
RUN mkdir -R /storage/cache && chown -Rf www-data.www-data /storage/cache && chmod -Rf 0755 /storage/cache
